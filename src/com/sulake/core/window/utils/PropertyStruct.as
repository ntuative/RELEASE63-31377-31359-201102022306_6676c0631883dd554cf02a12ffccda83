package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2759 = param3 == const_216 || param3 == const_123 || param3 == const_210 || param3 == const_215;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_216:
               ...
               _loc1_ = "<var key=\"" + this.var_580 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_215:
               ...
               break;
            case const_131:
               _loc1_ = "<var key=\"" + this.var_580 + "\" value=\"" + "0x" + uint(this.var_170).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_580 + "\" value=\"" + this.var_170 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
