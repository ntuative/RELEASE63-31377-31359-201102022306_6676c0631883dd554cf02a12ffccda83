package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1129:String = "_EXCLUDE";
      
      public static const const_1876:String = "_INCLUDE";
      
      public static const const_1764:String = "_TEMP";
      
      private static const const_1306:String = "layout";
      
      private static const const_928:String = "window";
      
      private static const const_930:String = "variables";
      
      private static const const_929:String = "filters";
      
      private static const const_589:String = "name";
      
      private static const const_1301:String = "style";
      
      private static const const_588:String = "params";
      
      private static const const_1294:String = "tags";
      ...
      private static const const_1304:String = "visible";
      
      private static const const_1299:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1110:String = "blend";
      
      private static const const_1293:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1308:String = "treshold";
      
      private static const const_1303:String = "children";
      
      private static const const_1300:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1305:String = "height_min";
      
      private static const const_1297:String = "height_max";
      ...
      private static const const_1296:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1309:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1225:Dictionary;
      
      protected var var_1226:Dictionary;
      
      protected var var_978:Dictionary;
      
      protected var var_1479:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1225,this.var_1226);
         this.var_978 = new Dictionary();
         this.var_1479 = new Dictionary();
         ParamCodeTable.fillTables(this.var_978,this.var_1479);
         this.var_1977 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1309,const_48);
         return param1.replace(const_1296,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1225)
            {
               delete this.var_1225[_loc1_];
            }
            for(_loc1_ in this.var_1226)
            {
               delete this.var_1226[_loc1_];
            }
            for(_loc1_ in this.var_978)
            {
               delete this.var_978[_loc1_];
            }
            for(_loc1_ in this.var_1479)
            {
               delete this.var_1479[_loc1_];
            }
            this.var_1977.dispose();
            this.var_1977 = null;
            this.var_16 = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1306)
         {
            _loc8_ = param1.child(const_930);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_929).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1225[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_589,variables,"")));
         style = uint(this.parseAttribute(xml,const_1301,variables,style));
         params = uint(this.parseAttribute(xml,const_588,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1294,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_158));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_158));
         rect.width = Number(this.parseAttribute(xml,const_1307,variables,const_158));
         rect.height = Number(this.parseAttribute(xml,const_1295,variables,const_158));
         visible = this.parseAttribute(xml,const_1304,variables,visible.toString()) == const_590;
         caption = unescape(String(this.parseAttribute(xml,const_1299,variables,caption)));
         ...
         if(xml.child(const_588).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_589,variables,"") as String;
               if(this.var_978[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_589)) + "\"!");
               }
               params |= this.var_978[param];
               i++;
            }
         }
         if(tag != const_48)
         {
            tags = tag.split(const_1298);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this.var_16.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_930)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1300,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1305,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1297,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_590;
         blend = Number(this.parseAttribute(xml,const_1110,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1293,variables,window.clipping.toString()) == const_590;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1308,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_929).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1226[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1129) == -1)
                  {
