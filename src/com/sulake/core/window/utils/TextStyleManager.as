package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_473:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_581:String = "{";
      
      private static const const_582:String = "}";
      
      private static const const_1251:String = "/*";
      
      private static const const_1252:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_178],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_178] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_473.indexOf(_loc4_.name) == -1)
            {
               var_473.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_582);
         if(countSubStrings(param1,const_581) != countSubStrings(param1,const_582))
         {
            throw new Error("Mismatching amount of \"" + const_581 + "\" versus \"" + const_582 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1251) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1252) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_581)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
