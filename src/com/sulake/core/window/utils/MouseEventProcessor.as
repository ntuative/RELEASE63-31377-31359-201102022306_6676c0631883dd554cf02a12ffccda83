package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_139:IWindowRenderer;
      
      protected var var_135:IDesktopWindow;
      
      protected var var_787:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_79 = param1.var_1207 as WindowController;
         this._lastClickTarget = param1.var_1206 as WindowController;
         this.var_139 = param1.renderer;
         this.var_787 = param1.var_1208;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_643.x || _loc3_.stageY != this.var_643.y)
            {
               this.var_643.x = _loc3_.stageX;
               this.var_643.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_135.groupParameterFilteredChildrenUnderPoint(this.var_643,_loc6_,WindowParam.const_29);
            }
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_79 && !this.var_79.disposed)
                     {
                        ...
                        {
                           this.var_787.mouseEventReceived(_loc3_.type,this.var_79);
                        }
                     }
                  }
         ...
         param1.var_1207 = this.var_79;
         param1.var_1206 = this._lastClickTarget;
         param1.renderer = this.var_139;
         param1.var_1208 = this.var_787;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_139.getDrawBufferForRenderable(param1);
