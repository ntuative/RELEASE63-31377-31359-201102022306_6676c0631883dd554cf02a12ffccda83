package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_196:Timer;
      
      protected var var_1478:uint = 0;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_196 = new Timer(40,0);
            this.var_196.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_196.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1214 *= 0.75;
         this.var_1215 *= 0.75;
         if(Math.abs(this.var_1214) <= 1 && Math.abs(this.var_1215) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_266 != null)
         {
            this.var_266(this.var_1214,this.var_1215);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_196.stop();
            this.var_196.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_196 = null;
         }
         if(this._working)
         {
