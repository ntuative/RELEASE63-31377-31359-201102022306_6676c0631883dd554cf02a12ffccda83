package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1245:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1244:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2744 = new Array();
         this.var_140 = this.profiler;
         this._windowManager = param2;
         this.var_833 = param3;
         var _loc4_:ByteArray = new var_1245() as ByteArray;
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_861)
            {
               this.var_1493 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      public function refresh(param1:Event) : void
      {
         ...
         if(this.var_1493)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_140.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_140.numBitmapAssetInstances + " / " + this.var_140.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_833.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_140.numTrackedBitmapDataInstances + " / " + this.var_140.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1244() as ByteArray;
