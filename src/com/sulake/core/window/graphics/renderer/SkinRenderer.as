   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_525[_loc1_]).dispose();
      ...
      {
         this.var_525[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in this.var_434)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_434[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_525[param1.name];
         }
         return param1;
      }
