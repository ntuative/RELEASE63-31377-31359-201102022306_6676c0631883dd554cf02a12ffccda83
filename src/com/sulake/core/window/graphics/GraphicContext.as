package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1484:uint = 0;
      
      public static const const_787:uint = 1;
      
      public static const const_1066:uint = 2;
      
      public static const const_657:uint = 4;
      
      public static const const_1369:uint = 8;
      
      public static const const_1419:uint = 16;
      
      public static const const_1734:uint = 64;
      
      public static const const_1820:uint = 128;
      
      public static const const_1124:uint = 256;
         ...
         if(this.var_792)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1980,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1980,16777215);
                  }
                  var_310 += bitmap.width * bitmap.height * 4;
               }
