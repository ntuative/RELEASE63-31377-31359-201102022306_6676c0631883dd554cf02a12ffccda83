package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_596:uint = 0;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1434 = 4294967295;
         this.var_936 = 0;
         this.var_1862 = new ColorTransform();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_949) : uint(const_596);
         var _loc6_:Boolean = this.var_180.width > 0 && this.var_180.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_936))
            {
               _loc5_ = const_948;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_948)
               {
                  ...
                  if(this.var_621)
                  {
                     ...
                     _loc7_.draw(param1,this.var_100,this.var_100.rect,this.var_936,false);
                  ...
                  {
                     this.var_973.tx = param2.x;
                     this.var_973.ty = param2.y;
                     this.var_1862.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_100,this.var_973,this.var_1862,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_832.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_168)
            {
               _loc2_ = this.var_832.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_168);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_832.getTheActualState(param1.type,param1.style,param1.state) != this.var_1434;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_488:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  _loc4_ = true;
               }
               ...
               break;
            case WindowRedrawFlag.const_1199:
               this.var_936 = this.var_832.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_936 != this.var_1434)
               {
                  this.var_621 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1110:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_621 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1152:
               _loc4_ = true;
         }
         if(_loc4_)
         {
