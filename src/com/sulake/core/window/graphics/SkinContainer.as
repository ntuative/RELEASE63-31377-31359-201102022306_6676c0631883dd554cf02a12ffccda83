package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1258:String = "skin";
      
      private static const const_1262:String = "bitmap";
      
      private static const const_1261:String = "fill";
      
      private static const const_1259:String = "text";
      
      private static const const_1260:String = "label";
      
      private static const const_1263:String = "shape";
      ...
      private var var_2341:Dictionary;
      
      private var var_2339:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1664,this.var_2340);
         this.var_2341 = new Dictionary();
         this.var_2339 = new Dictionary();
         StateCodeTable.fillTables(this.var_2341,this.var_2339);
         this.var_396 = new Dictionary();
         this.var_396[const_1258] = BitmapSkinRenderer;
         this.var_396[const_1262] = BitmapDataRenderer;
         this.var_396[const_1261] = FillSkinRenderer;
         this.var_396[const_1259] = TextSkinRenderer;
         this.var_396[const_1260] = LabelRenderer;
         this.var_396[const_1263] = ShapeSkinRenderer;
         this.var_396[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_396[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_309 == null)
         {
            var_309 = new Array();
            var_309.push(WindowState.const_66);
            var_309.push(WindowState.const_75);
            var_309.push(WindowState.const_86);
            var_309.push(WindowState.const_51);
            var_309.push(WindowState.const_85);
            var_309.push(WindowState.const_82);
            var_309.push(WindowState.const_104);
            var_309.push(WindowState.const_97);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1664[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_860[param1] == null)
         {
            this.var_860[param1] = new Array(const_917);
         }
         this.var_860[param1][param2] = param3;
         if(this.var_861[param1] == null)
         {
            this.var_861[param1] = new Array(const_917);
         }
         this.var_861[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_860[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_168)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_861[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_168)
