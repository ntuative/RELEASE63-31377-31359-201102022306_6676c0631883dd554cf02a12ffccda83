package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_373 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_59 = var_373.clone();
            var_11 = var_373.clone();
         ...
         if(_loc13_)
         {
            var_653 = _loc13_.blend;
            var_438 = _loc13_.var_2719;
            if(var_437 != _loc13_.background)
            {
      ...
      public static function method_2(param1:WindowController, param2:IWindow) : void
      {
      ...
      {
         return this.var_640 != null ? this.var_640 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_437 = param1;
         var_227 = !!var_437 ? uint(var_227 | var_528) : uint(var_227 & 16777215);
      ...
      {
         var_528 = param1 & 4278190080;
         var_227 = !!var_437 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_65);
      }
      ...
      {
         var_528 = param1 << 24;
         var_227 = !!var_437 ? uint(var_528 | var_227) : uint(16777215 & var_227);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_65);
      }
      
      public function set blend(param1:Number) : void
      {
         var_653 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_80 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_476,this,null));
         }
      }
      ...
      {
         var_438 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_318 = this._parent.rectangle.clone();
               var_59.x = var_11.x;
               var_59.y = var_11.y;
               var_59.width = var_11.width;
               var_59.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_434,this,this._parent));
            }
            else
            {
               this.var_318.x = 0;
               this.var_318.y = 0;
               this.var_318.width = 0;
               this.var_318.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1200,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_787,var_11);
            this.var_21.visible = var_374;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_19,var_16,var_11,null,this.var_640,this.properties,var_796.concat(),_id) as WindowController;
         _loc2_.var_438 = var_438;
         _loc2_.var_162 = this.var_162;
         _loc2_._debug = this._debug;
         _loc2_.var_318 = this.var_318.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_373 = var_373.clone();
         ...
         _loc2_.var_528 = var_528;
         _loc2_.var_795 = var_795;
         _loc2_.var_374 = var_374;
         _loc2_.var_653 = var_653;
         _loc2_.var_19 = var_19;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_20;
         _loc2_.background = var_437;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2059 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_16.invalidate(this,param1,WindowRedrawFlag.const_65);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_569)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_19 & 0);
            if(_loc7_ == WindowParam.const_547)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_820,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_528,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_187,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_694))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1115;
                  if(testParamFlag(WindowParam.const_329))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_253))
                        {
                  ...
                  if((var_19 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_318))
                        {
               ...
               case WindowMouseEvent.const_57:
                  ...
                  if(testParamFlag(WindowParam.const_253))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_187:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_566,this,null));
                     if(testParamFlag(WindowParam.const_189,WindowParam.const_153))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_194,WindowParam.const_155))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_567))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_19 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_274,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_528:
                  var_16.invalidate(this,var_11.union(var_59),WindowRedrawFlag.const_488);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1068,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_288,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_381:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_636,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_227,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_437:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_1199);
                  break;
               ...
               case WindowNotifyEvent.const_507:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_488);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_566:
                  this._parent.getRegionProperties(null,this.var_318);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_358:
                  if(testParamFlag(WindowParam.const_70))
                  {
                     method_2(this,WindowNotifyEvent(param2).related);
                  }
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1191:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1553:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1389:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1089:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1181:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1134:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1186:
               _loc2_ = "null";
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_438);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_438);
      }
         ...
         if(this.var_162 && var_438 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1251,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1251,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_124,WindowParam.const_153);
         var _loc2_:* = !testParamFlag(WindowParam.const_129,WindowParam.const_155);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_318.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_318.height;
               _loc5_ = uint(var_19 & 0);
      ...
      {
         if(_state == WindowState.const_533)
         {
            return true;
         }
         _state = WindowState.const_533;
         ...
         _loc1_.type = WindowNotifyEvent.const_1181;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1166;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1044,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_1191;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_66,true);
         _loc1_.type = WindowNotifyEvent.const_1163;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1188;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_993 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_358,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_993 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_794,this,param1));
         return param1;
      }
