package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_747:Boolean = false;
      ...
      {
         this.var_1222 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1066,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_502)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_747 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_333,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_691,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1414);
         _loc1_.push(this.var_1224 != PropertyDefaults.const_1105 ? new PropertyStruct(PropertyDefaults.const_663,this.var_1224,PropertyStruct.const_37,true) : PropertyDefaults.const_1412);
         _loc1_.push(_field.selectable != PropertyDefaults.const_990 ? new PropertyStruct(PropertyDefaults.const_670,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1438);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1136 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1641);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_663:
                  this.var_1224 = _loc2_.value as Boolean;
                  if(this.var_1224)
                  {
               ...
               case PropertyDefaults.const_670:
                  ...
                  break;
               case PropertyDefaults.const_691:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1142:
