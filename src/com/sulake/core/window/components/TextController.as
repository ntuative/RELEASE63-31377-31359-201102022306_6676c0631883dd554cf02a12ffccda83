package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1209:Dictionary = createPropertySetterTable();
      ...
      protected var var_981:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_418,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_418 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_418,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_637 ? true : null;
         }
      ...
      {
         this.var_791 = param1;
         this._field.scrollH = this.var_791 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_791 * this.maxScrollH,this.var_526 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1046) ? new PropertyStruct(PropertyDefaults.const_606,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_973) : PropertyDefaults.const_1462);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1106 ? new PropertyStruct(PropertyDefaults.const_693,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1055) : PropertyDefaults.const_1623);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_131,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1023 ? new PropertyStruct(PropertyDefaults.const_1167,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1095) : PropertyDefaults.const_1479);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_605) ? new PropertyStruct(PropertyDefaults.const_344,this._field.textColor,PropertyStruct.const_131,true) : PropertyDefaults.const_1058);
         ...
         _loc1_.push(this.var_37.left != PropertyDefaults.const_775 ? new PropertyStruct(PropertyDefaults.const_221,this.var_37.left,PropertyStruct.const_38,true) : PropertyDefaults.const_562);
         _loc1_.push(this.var_37.top != PropertyDefaults.const_683 ? new PropertyStruct(PropertyDefaults.const_217,this.var_37.top,PropertyStruct.const_38,true) : PropertyDefaults.const_532);
         _loc1_.push(this.var_37.right != PropertyDefaults.const_870 ? new PropertyStruct(PropertyDefaults.const_234,this.var_37.right,PropertyStruct.const_38,true) : PropertyDefaults.const_574);
         _loc1_.push(this.var_37.bottom != PropertyDefaults.const_883 ? new PropertyStruct(PropertyDefaults.const_268,this.var_37.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_462);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1016 ? new PropertyStruct(PropertyDefaults.const_859,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1624);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_220,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_220,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_220,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
