package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1966:Boolean = false;
      ...
      protected var var_972:Boolean = true;
      
      protected var var_429:Boolean = false;
      
      protected var var_1212:Boolean = false;
      
      protected var var_1965:int = 0;
      
      protected var var_1967:int = 0;
      
      protected var var_1213:Number;
      
      protected var var_1210:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_102 = 0;
         this.var_91 = 0;
         this._horizontal = param2 == WindowType.const_347;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_162 = var_437 || !testParamFlag(WindowParam.const_32);
         this._container = var_16.create("_CONTAINER","",WindowType.const_341,WindowStyle.const_628,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this.resizeOnItemUpdate = this.var_1212;
      }
      ...
      {
         return new Rectangle(this.var_641 * this.maxScrollH,this.var_642 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_641 = param1;
            this._container.x = -this.var_641 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_65);
            dispatchEvent(new WindowEvent(WindowEvent.const_517,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_642 = param1;
            this._container.y = -this.var_642 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_65);
            dispatchEvent(new WindowEvent(WindowEvent.const_517,this,null));
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_567,param1);
            }
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_172:
               if(this.var_1211)
               {
                  this.var_1213 = this.var_1965 - _loc3_;
                  this.var_1210 = this.var_1967 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1210 != 0 && this.var_91 != 0)
                  {
                     this.scrollV += this.var_1210 / this.var_91;
                  }
                  this.var_1965 = _loc3_;
                  this.var_1967 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_196:
               if(this.var_1211)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1213,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1210);
                  }
                  this.var_1211 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_972 && !this.var_521 && this._container)
         {
            this.var_521 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_364,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1063);
         }
         if(this.var_972 != PropertyDefaults.const_1192)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_711,this.var_972,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1373);
         }
         if(this.var_429 != PropertyDefaults.const_1093)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_654,this.var_429,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1541);
         }
         if(this.var_1212 != PropertyDefaults.const_999)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_866,this.var_1212,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1503);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_364:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_654:
               ...
               case PropertyDefaults.const_866:
                  ...
                  break;
               case PropertyDefaults.const_711:
                  this.var_972 = _loc2_.value as Boolean;
                  break;
            }
         }
