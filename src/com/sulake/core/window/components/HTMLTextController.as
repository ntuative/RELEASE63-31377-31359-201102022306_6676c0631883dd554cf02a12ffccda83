package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_863:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_708:String;
      
      private var var_1085:String = null;
      
      private var var_1677:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1085 == param2)
         {
            return;
         }
         param1.var_1085 = param2;
         param1.var_1677 = null;
         if(param1.var_1085 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1085);
            param1.var_1677 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_841.indexOf(param1) > -1)
         {
            this.var_708 = param1;
         }
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1677;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_851,this.var_708,PropertyStruct.const_52,true,PropertyDefaults.const_841));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1493);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_851)
            {
