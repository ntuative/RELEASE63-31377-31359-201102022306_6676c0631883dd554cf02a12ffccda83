package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_395)
         {
            this.var_395.removeEventListener(WindowEvent.const_298,this.method_3);
            this.var_395.removeEventListener(WindowEvent.const_251,this.method_3);
            this.var_395 = null;
         }
         if(this.var_1063)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_395)
         {
            this.var_395 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_395)
            {
               this.var_395.addEventListener(WindowEvent.const_298,this.method_3);
               this.var_395.addEventListener(WindowEvent.const_251,this.method_3);
            }
         }
         return this.var_395;
      }
      ...
      private function method_3(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_251)
         {
            this.hideScrollBar();
         }
      }
