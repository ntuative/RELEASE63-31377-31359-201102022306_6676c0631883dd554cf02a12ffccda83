package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1211:String = "_TITLE";
      ...
      private var var_1348:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1211) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1348 = findChildByTag(const_1274) as IHeaderWindow;
            if(!this.var_1348)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_167 = findChildByTag(const_1273) as IWindowContainer;
            if(!this.var_167)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1208,_loc2_,false);
      ...
      {
         return this.content != null && this.var_980 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_318);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_264);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_252);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_312,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_221,_loc3_.left,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_217,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_234,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
