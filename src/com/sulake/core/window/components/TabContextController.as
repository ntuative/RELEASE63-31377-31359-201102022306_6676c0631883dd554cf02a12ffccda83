package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1271:String = "_SELECTOR";
      
      private static const const_1272:String = "_CONTENT";
       
      
      protected var var_977:ITabSelectorWindow;
      
      protected var var_1975:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_977 = findChildByTag(const_1271) as ITabSelectorWindow;
            if(this.var_977 != null)
            {
               this.var_977.procedure = this.selectorEventProc;
            }
         }
         return this.var_977;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1975 = findChildByTag(const_1272) as IWindowContainer;
         }
      ...
      {
         return !!this.var_747 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_977.numSelectables;
      }
