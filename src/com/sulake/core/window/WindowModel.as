package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_373:Rectangle;
      ...
      protected var var_528:uint;
      
      protected var var_438:uint = 10;
      
      protected var var_795:Boolean = true;
      
      protected var var_374:Boolean = true;
      
      protected var var_653:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_80 = param4;
         this.var_796 = param8 == null ? new Array() : param8;
         this.var_16 = param6;
         this.var_11 = param7.clone();
         this.var_373 = param7.clone();
      ...
      {
         return this.var_373.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_373.height;
      }
