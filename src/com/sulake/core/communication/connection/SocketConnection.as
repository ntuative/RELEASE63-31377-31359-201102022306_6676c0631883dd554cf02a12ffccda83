package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1451:int = 10000;
      ...
      private var var_474:ByteArray;
      
      private var var_1078:IEncryption;
      
      private var var_705:IProtocol;
      
      private var _id:String;
      
      private var var_1077:IMessageClassManager;
      
      private var var_290:ICoreCommunicationManager;
      
      private var var_475:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_290 = param2;
         this.var_474 = new ByteArray();
         this.var_1077 = new MessageClassManager();
         this.var_77 = new Socket();
         this.var_330 = new Timer(const_1451,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_475)
         {
            this.var_475.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_330.start();
         this.var_704 = getTimer();
      ...
      {
         this.var_290.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1077.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_705.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_475)
         {
            this.var_475.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1078 != null)
         {
            _loc3_ = this.var_1078.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1077.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_705.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_705.method_9 + "\n";
         return _loc1_ + ("Encryption: " + this.var_1078 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_705.getMessages(this.var_474,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_475)
               {
                  this.var_475.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1077.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_290.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        dataWrapper = new MessageDataWrapper(dataClone,this.protocol.method_9);
                        parserInstance = this.var_290.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_474,offset);
               this.var_474 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_474.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_474.writeByte(this.var_77.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_330.stop();
         this.var_1656 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_704));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1656 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_704));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_704));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_704));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_704));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_704));
