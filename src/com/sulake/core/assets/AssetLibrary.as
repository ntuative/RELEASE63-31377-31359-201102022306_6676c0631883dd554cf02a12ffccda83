package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1039:String = "AssetLibraryReady";
      
      public static const const_651:String = "AssetLibraryLoaded";
      
      public static const const_1423:String = "AssetLibraryUnloaded";
      
      public static const const_1607:String = "AssetLibraryLoadError";
      
      private static var var_289:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_719 = new XML();
         this.var_404 = 0;
         this.var_406 = new Array();
         if(var_289 == null)
         {
            var_289 = new Dictionary(false);
         ...
         ++var_480;
         this.var_405 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_880.splice(var_880.indexOf(this),1);
            --var_480;
            this.var_479 = null;
            this.var_877 = null;
            this.var_153 = null;
      ...
      {
         if(this._file == param1.url && this.var_878)
         {
            if(!this.var_879 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_719,this.var_581);
            }
            this.var_879 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1039));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_479)
         {
            _loc2_ = this.var_479[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_479[_loc1_];
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_479[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1114,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1122,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_986,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_479[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_479[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_404;
                     this.var_406.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_479[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_406.length ? this.getAssetByName(this.var_406[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_153)
         {
            ...
            {
               return this.var_406.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_153[param1] != null || (this.var_581 != null ? this.var_581[param1] != null : false);
      }
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_153)
            {
               if(this.var_153[_loc2_] == param1)
               {
                  this.var_406.splice(this.var_406.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_289.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_289[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_405.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_405[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_289[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_405[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_289)
            {
               _loc3_ = AssetTypeDeclaration(var_289[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_405)
         {
            _loc3_ = AssetTypeDeclaration(this.var_405[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_289)
            {
               _loc4_ = AssetTypeDeclaration(var_289[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_405)
         {
            _loc4_ = AssetTypeDeclaration(this.var_405[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_719 = _loc2_.manifest.copy();
         this.var_581 = _loc2_.resource;
         ...
         this.var_878 = true;
         dispatchEvent(new Event(AssetLibrary.const_651));
         dispatchEvent(new Event(AssetLibrary.const_1039));
         if(this.var_879)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_719.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_581[param1]);
