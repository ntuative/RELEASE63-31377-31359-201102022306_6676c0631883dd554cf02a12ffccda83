   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_103 is BitmapDataAsset)
         {
            ...
            this.var_1259 = BitmapDataAsset(this.var_103).var_1259;
            this.var_1260 = BitmapDataAsset(this.var_103).var_1260;
            if(this._bitmap != null)
            {
               this.var_103 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1259 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1260 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
