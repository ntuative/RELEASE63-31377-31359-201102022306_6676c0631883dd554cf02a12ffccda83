package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_975 = new LoaderContext();
         this.var_975.checkPolicyFile = true;
         ...
         {
            this.var_39.load(param2,this.var_975);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_308 = 0;
         this.var_39.load(param1,this.var_975);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_308 < var_2727)
            {
               ...
               this.var_39.load(new URLRequest(this.var_974 + (this.var_974.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_308),this.var_975);
               return true;
            }
         }
         return false;
