package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_603:Map = new Map();
      
      private static const const_327:Map = new Map();
      
      private static var var_1203:Boolean = false;
      ...
      {
         return const_603.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1203)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_603.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1203 = true;
         }
