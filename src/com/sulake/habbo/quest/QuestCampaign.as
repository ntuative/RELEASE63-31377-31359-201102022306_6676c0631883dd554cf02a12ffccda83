package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_508:Quest;
      
      private var var_302:QuestView;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1168 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1427 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_301 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1427.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1427.findChildByName("currency.amount").caption = "${quest_" + this.var_1841 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_1169 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1169)
         {
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_508)
         {
            this.var_508.selected = false;
         }
         if(this.var_177)
         {
            this.var_1168.addChild(this.var_177.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1536);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1427.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_358.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_358)
         {
            this.var_301.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_44 || _loc4_.status == QuestStatusEnum.const_546))
            {
               _loc3_ = _loc4_;
            }
         }
         ...
         else if(this.var_358.length > 0)
         {
            this.activateListItem(this.var_358[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_508 = param1;
         this.var_508.selected = true;
         this.showQuestData(this.var_508);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_302 = new QuestView(this,param1);
         this.var_1168.addChild(this.var_302.view);
         this.var_302.init();
      }
