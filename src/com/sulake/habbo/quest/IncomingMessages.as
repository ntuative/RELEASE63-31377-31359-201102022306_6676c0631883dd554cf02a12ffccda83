package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_144 = param1;
         this._communication = this.var_144.communication;
      ...
      private function onQuestList(param1:IMessageEvent) : void
      {
         ...
         this.var_144.controller.openCampaign(_loc2_.campaignCode,_loc2_.activityPointType,_loc2_.quests);
      }
      ...
      private function onQuestAccepted(param1:IMessageEvent) : void
      {
         ...
         this.var_144.controller.questAccepted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_144.controller.questCompleted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onAvailableQuestCampaign(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length == 0)
         {
            ...
            this.var_663 = this.var_144.windowManager.alert("quest.nocampaigns.title","quest.nocampaigns.desc",0,this.onCloseAlert);
         }
         else
         {
            this.var_144.controller.openCampaigns(_loc2_.campaignCodes);
         }
      }
      ...
      private function onExpiredQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length > 0)
         {
            this.var_144.controller.openCampaigns(_loc2_.campaignCodes,true);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_144.toolbar != null && this.var_144.configuration != null)
         {
            _loc2_ = this.var_144.configuration.getKey("questing.supportMultipleCampaigns","");
            _loc3_ = this.var_144.configuration.getKey("questing.defaultCampaign","");
            if(_loc3_ && _loc3_ != "" || _loc2_ && _loc2_ == "true")
            {
               this.var_144.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      {
         this.var_144.controller.close();
         this.var_144.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.QUESTS));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_144.controller.updatePurse();
      }
