package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      {
         if(this.var_599 != MODE_TABS)
         {
            this.var_599 = MODE_NO_TABS;
         }
         this.detachCampaign();
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1092.addChild(this.var_288.window);
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1092 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_151.getKeys())
         {
            ...
            if(!_loc2_)
            {
               _loc2_ = this.var_144.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_531) as ITabButtonWindow;
               _loc1_.addTabItem(_loc2_);
               _loc2_.addEventListener(WindowEvent.const_58,this.onTabSelect);
            }
            _loc5_ = 4287150640;
            if(!_loc3_.expired)
            {
