package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1024:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_541 = new Timer(100);
         this.var_541.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,80,"g"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,74,"h"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,416,"o"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,352,"p"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,304,"q"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,336,"r"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,748,"u"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_62,438,"v"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_54,540,"t"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_54,512,"w"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_54,396,"x"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_54,440,"y"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_54,456,"z"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_54,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_541)
         {
            this.var_541.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_541.reset();
            this.var_541 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1024.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1557 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1557 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_167 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_56 = IItemListWindow(this.var_167.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_167.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1023 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_167.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_167.desktop,this.var_167.width,this.var_167.height);
         this.var_167.x = _loc4_.x;
         this.var_167.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1023.goBackToInitialState();
         this.var_1023.input.textBackgroundColor = 4294967295;
         this.var_1024 = this.var_40[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1023.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_167.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_167.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1023.getText();
         var _loc3_:String = "model_" + this.var_1024.name;
