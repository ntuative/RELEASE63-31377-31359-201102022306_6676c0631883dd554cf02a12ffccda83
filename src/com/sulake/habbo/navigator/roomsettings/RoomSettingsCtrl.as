package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1041:TextFieldManager;
      
      private var var_823:TextFieldManager;
      
      private var var_825:TextFieldManager;
      
      private var var_824:TextFieldManager;
      ...
      private var var_2177:ITextWindow;
      
      private var var_2178:ITextWindow;
      ...
      {
         if(param1 != this.var_323 || this.var_1040 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1040 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1383)
         {
            this.var_678.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1358)
         {
            this.var_678.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1456)
         {
            this.var_1041.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1464)
         {
            this.setTagError(this.var_823,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_825,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1544)
         {
            this.setTagError(this.var_823,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_825,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1613)
         {
            this.var_824.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_678.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_678.clearErrors();
         this.var_1041.clearErrors();
         this.var_823.clearErrors();
         this.var_825.clearErrors();
         this.var_824.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_451,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_774,this.onDoorModePasswordUnselect);
         ...
         this.var_678 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1041 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_823 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_825 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_824 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1035 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1037 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1039 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1034 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_549 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1575 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1284 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1036 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1033 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1576 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1283 = IWindowContainer(this._window.findChildByName("footer_container"));
         ...
         this.var_2177 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2178 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1577 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1577.procedure = this.onSwitchView;
         this.var_1038.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1575.visible = this._inRoom;
         this.var_1576.visible = this._inRoom;
         this.var_2178.visible = this.var_458;
         this.var_2177.visible = !this.var_458;
         if(this.var_458)
         {
            this.var_1033.visible = true;
            this.var_1283.visible = false;
            this.refreshFlatControllers();
            this.var_1033.height = Util.getLowestPoint(this.var_1033) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1036.visible = true;
            this.var_1283.visible = true;
            this.var_1284.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1284.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1036.height = Util.getLowestPoint(this.var_1036) + 4;
         }
         this.var_1577.text = !!this.var_458 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1575.name,this.var_1284.name,this.var_1036.name,this.var_1033.name,this.var_1283.name,this.var_1576.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_678.setText(_loc1_.name);
         this.var_1041.setText(_loc1_.description);
         this.var_824.setText("");
         this.var_1035.setText("");
         ...
         this.setTag(this.var_823,_loc1_.tags[0]);
         this.setTag(this.var_825,_loc1_.tags[1]);
         if(this.var_1037)
         {
            if(_loc1_.allowPets)
            {
               this.var_1037.select();
            }
            else
            {
               this.var_1037.unselect();
            }
         }
         if(this.var_1039)
         {
         ...
         if(this.var_1034)
         {
            ...
            {
               this.var_1034.select();
            }
            else
            {
               this.var_1034.unselect();
            }
         }
         if(this.var_549)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_678.getText();
         _loc2_.description = this.var_1041.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_552;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_119)
         {
            _loc8_ = this.var_824.getText();
            _loc9_ = this.var_1035.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_824.clearErrors();
               this.var_1035.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1037.isSelected;
         _loc2_.allowFoodConsume = this.var_1039.isSelected;
         _loc2_.allowWalkThrough = this.var_1034.isSelected;
         _loc2_.hideWalls = this.var_549.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_823,_loc2_.tags);
         this.addTag(this.var_825,_loc2_.tags);
         this.clearErrors();
         this.var_1040 = _loc2_.roomId;
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_56,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,100,20)));
      }
