package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_755:TextFieldManager;
      ...
      private var var_2604:ITextWindow;
      ...
      private var var_2603:IButtonWindow;
      
      private var var_1425:IButtonWindow;
      
      private var var_926:IDropMenuWindow;
      ...
      {
         this.var_926.visible = false;
         this.var_1832.visible = true;
         this.var_2604.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_755.setText(param1.eventDescription);
         this.var_823.setText(this.getTagFromEvent(param1,1));
         this.var_825.setText(this.getTagFromEvent(param1,2));
         this.var_1424.visible = false;
         this.var_1423.visible = true;
         this.var_1425.visible = true;
         this.var_1831.visible = false;
         this.var_1830.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_926.visible = true;
         this.var_1832.visible = false;
         this.var_1424.visible = true;
         this.var_1423.visible = false;
         this.var_1425.visible = false;
         this.var_755.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_823.goBackToInitialState();
         this.var_825.goBackToInitialState();
         this.var_926.selection = 0;
         this.var_1831.visible = true;
         this.var_1830.visible = false;
      }
      ...
      {
         var _loc1_:int = this.var_926.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_755.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_823.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_755.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1832 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2604 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1831 = ITextWindow(this.find("create_caption"));
            this.var_1830 = ITextWindow(this.find("edit_caption"));
            this.var_1424 = IButtonWindow(this.find("create_button"));
            this.var_1423 = IButtonWindow(this.find("edit_button"));
            this.var_2603 = IButtonWindow(this.find("cancel_button"));
            this.var_1425 = IButtonWindow(this.find("end_button"));
            this.var_926 = IDropMenuWindow(this.find("event_type"));
            ...
            Util.setProcDirectly(this.var_2603,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_755 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_823 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_825 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
