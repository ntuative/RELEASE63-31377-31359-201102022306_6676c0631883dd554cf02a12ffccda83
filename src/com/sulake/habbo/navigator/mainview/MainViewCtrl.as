package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1897:int = 3;
      
      public static const const_1048:int = 4;
      
      private static const const_954:int = 1;
      
      private static const const_597:int = 2;
      
      private static const const_953:int = 3;
      
      private static const const_1334:int = 4;
      ...
      private var var_1183:OfficialRoomListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1183 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function open() : void
      {
         ...
         if(_loc1_)
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,this.var_17));
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_258 = ITabContextWindow(this.var_17.findChildByName("tab_context"));
         if(!this.var_258)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_167 = IWindowContainer(this.var_17.findChildByName("tab_content"));
         this.var_220 = IWindowContainer(this.var_17.findChildByName("custom_content"));
         this.var_197 = IWindowContainer(this.var_17.findChildByName("list_content"));
         this.var_261 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1444 = this.var_17.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_17.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1181 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(!this.var_1181)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1181.procedure = this.onHotelView;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_677,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1512,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_167,["custom_content","list_content"],this.var_220.y,8);
         this.var_197.height = this.var_197.height + _loc1_ - this.var_197.y - this.var_261.height + this.var_2670;
         Util.moveChildrenToColumn(this.var_167,["list_content","custom_footer"],this.var_197.y,0);
         this.var_2670 = this.var_261.height;
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_261);
      ...
      {
         this.refreshList(param1,param2,this.var_1183,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_627 == const_954)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_197.blend - _loc2_));
            this.var_197.blend = _loc3_;
            this.var_220.blend = !!this.var_1182 ? Number(_loc3_) : Number(1);
            this.var_261.blend = !!this.var_1182 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_627 = const_597;
            }
         }
         else if(this.var_627 == const_597)
         {
            if(this.var_1443 % 10 == 1)
            {
            ...
            {
               this.var_627 = const_953;
            }
         }
         else if(this.var_627 == const_953)
         {
            this.refresh();
            this.var_627 = const_1334;
         }
         else
         {
      ...
      {
         this._navigator.refreshButton(this.var_1181,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1181,"icon_hotelview_reactive",param1,null,0);
      }
