package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_457:RoomPopupCtrl;
      
      private var var_526:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_457 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_526 = IScrollbarWindow(this.var_167.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         this.var_167.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1521,true);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_457.visible && this.var_2175)
            {
               return;
            }
            ...
            this.var_457.room = _loc4_;
            this.var_457.showPopup(param2);
         }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1282.tags[0];
            this.var_1282.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2176 - _loc2_.stageX);
         this.var_2176 = _loc2_.stageX;
         this.var_2175 = _loc3_ > 2;
      }
   }
}
