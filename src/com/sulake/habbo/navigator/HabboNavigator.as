package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_632:RoomInfoViewCtrl;
      
      private var var_1197:RoomCreateViewCtrl;
      ...
      private var var_2808:Dictionary;
      ...
      private var var_2450:RoomThumbnailRenderer;
      
      private var var_824:GuestRoomPasswordInput;
      
      private var var_315:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_632 = new RoomInfoViewCtrl(this);
         this.var_1197 = new RoomCreateViewCtrl(this);
         this.var_2450 = new RoomThumbnailRenderer(this);
         this.var_824 = new GuestRoomPasswordInput(this);
         this.var_315 = new GuestRoomDoorbell(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_285,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_632.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_306.startSearch(Tabs.const_226,Tabs.const_391,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_306.startSearch(Tabs.const_272,Tabs.const_237);
         this.var_416.getTab(Tabs.const_272).tabPageDecorator.tabSelected();
      }
