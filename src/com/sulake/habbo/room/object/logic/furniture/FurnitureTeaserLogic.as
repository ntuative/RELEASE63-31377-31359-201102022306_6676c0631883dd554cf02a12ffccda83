package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_1949:String = "TYPE_INJECTED";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         else if(param1.type == MouseEvent.DOUBLE_CLICK)
         {
            if(eventDispatcher != null)
            {
               _loc5_ = object.getId();
               _loc6_ = object.getType();
               _loc7_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_425,_loc5_,_loc6_);
               eventDispatcher.dispatchEvent(_loc7_);
            }
         }
