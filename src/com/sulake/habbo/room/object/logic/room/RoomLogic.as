package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1591:int = 255;
      
      private var var_1452:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1185,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_869,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_736,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_702,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_726,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1188)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1591;
            if(_loc2_ - this.var_1188 >= this.var_1895)
            {
               _loc3_ = this.var_1189;
               _loc4_ = this.var_1896;
               this.var_1188 = 0;
            }
            else
            {
               _loc7_ = this.var_1452 >> 16 & 255;
               _loc8_ = this.var_1452 >> 8 & 255;
               _loc9_ = this.var_1452 & 255;
               _loc10_ = this.var_1189 >> 16 & 255;
               _loc11_ = this.var_1189 >> 8 & 255;
               _loc12_ = this.var_1189 & 255;
               _loc13_ = (_loc2_ - this.var_1188) / this.var_1895;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1897 + (this.var_1896 - this.var_1897) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_869,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_641:
               param2.setString(RoomObjectVariableEnum.const_886,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_770:
               param2.setString(RoomObjectVariableEnum.const_823,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_678:
               param2.setString(RoomObjectVariableEnum.const_696,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_548:
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_806:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1138,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1133:
               param2.setNumber(RoomObjectVariableEnum.const_736,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1102:
               param2.setNumber(RoomObjectVariableEnum.const_702,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_726,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1084,int(param1.bgOnly));
         this.var_1452 = this._color;
         this.var_1897 = this.var_1591;
         this.var_1189 = _loc3_;
         this.var_1896 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_559,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1582,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1433,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1477,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_559,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_192)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_150 || _loc13_ == RoomPlaneData.const_278)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
