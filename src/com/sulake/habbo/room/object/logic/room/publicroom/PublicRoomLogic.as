package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_850,"");
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1143:
                  _loc2_.setString(RoomObjectVariableEnum.const_356,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_850,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_456,Number(true));
                  this.var_1460 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1051);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_570)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_850);
