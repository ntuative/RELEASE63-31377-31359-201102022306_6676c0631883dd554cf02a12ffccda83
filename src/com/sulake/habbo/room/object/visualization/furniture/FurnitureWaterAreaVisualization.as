package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1285:String = "shore";
      ...
      {
         if(this.var_2441 == param1 && this.var_2440 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1285)
            {
               this.var_1733 = _loc2_;
               this.var_2441 = param1;
               this.var_2440 = _direction;
               return this.var_1733;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1732 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_408.length)
         {
            if(this.var_408[_loc5_] == true)
            {
               this.var_1732 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_483 == 0 || this.var_583 == 0)
         {
            ...
            this.var_483 = _loc2_.getNumber(RoomObjectVariableEnum.const_299);
            this.var_583 = _loc2_.getNumber(RoomObjectVariableEnum.const_393);
         }
         this.var_408 = [];
         this.var_584 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_483 * 2 + this.var_583 * 2)
         {
            this.var_408.push(false);
            this.var_584.push(ShoreMaskCreatorUtility.const_76);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_66,getSize(param3),this.var_408,this.var_584,assetCollection);
      }
