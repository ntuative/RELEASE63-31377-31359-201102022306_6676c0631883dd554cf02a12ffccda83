package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1382:String = "cone";
      
      public static const const_1546:String = "plane";
      
      public static const const_1525:String = "sphere";
      ...
      private var var_870:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_869 = 0;
         this.var_868 = false;
         this.init(0,0,0,this._direction,this.var_2382,this.var_870,this.var_2381,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2385)
         {
            switch(this.var_2384)
            {
               case const_1382:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_870,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1096.length);
         return this.var_1096[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_869 < this.var_1346)
         {
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_869 < this.var_1346)
         {
            ...
            this.y = (2 - this.var_244) * this.y - (1 - this.var_244) * this.lastY + this.var_1699 * this.var_870 * this.var_870;
         ...
         var _loc1_:* = [];
         for each(_loc2_ in this.var_337)
         {
            _loc2_.update();
            _loc3_ = _loc2_.x;
            _loc4_ = _loc2_.y;
            ...
            _loc2_.y = (2 - this.var_244) * _loc2_.y - (1 - this.var_244) * _loc2_.lastY + this.var_1699 * this.var_870 * this.var_870;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_337.splice(this.var_337.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
