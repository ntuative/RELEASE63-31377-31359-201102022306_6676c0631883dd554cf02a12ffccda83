package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1489:int = 16777215;
      
      public static const const_1398:int = 13421772;
      
      private static const const_937:int = 16777215;
      
      private static const const_936:int = 13421772;
      
      private static const const_939:int = 10066329;
      
      private static const const_938:int = 10066329;
      
      public static const const_1586:int = 16777215;
      
      public static const const_1535:int = 13421772;
      ...
      private var var_745:Rectangle = null;
      ...
      private var var_1490:String = null;
      ...
      private const const_1975:int = 250;
      
      private var var_1609:int = -1;
      
      private var var_1305:Number = 0.0;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_745 = super.boundingRectangle;
         }
         return new Rectangle(this.var_745.x,this.var_745.y,this.var_745.width,this.var_745.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1185);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_994);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1501)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_120,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1975 && !_loc5_ && !_loc7_)
         {
            return;
         }
            ...
            while(_loc9_ < this.var_351.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_92)
               {
                  if(this.var_1795)
                  {
                     ...
                     _loc14_ = uint((_loc13_ & 255) * this.var_2526 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2529 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1609)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1305 || _loc3_.y != this.var_2233 || _loc3_.z != this.var_2237 || param1.scale != this.var_2234))
            {
               this.var_1305 = _loc3_.x;
               this.var_2233 = _loc3_.y;
               this.var_2237 = _loc3_.z;
               this.var_2234 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1138);
            if(_loc3_ != this.var_2528)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2528 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_869));
            if(_loc4_ != this.var_1144)
            {
               this.var_1144 = _loc4_;
               this.var_2526 = this.var_1144 & 255;
               this.var_2529 = this.var_1144 >> 8 & 255;
               this.var_2527 = this.var_1144 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1084));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_163 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_823);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_886);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_696);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_736));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_702));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_726));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1657;
      }
         ...
         while(_loc8_ < this.var_499.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_125.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_120 || _loc3_.type == RoomPlane.const_92)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_120 || _loc3_.type == RoomPlane.const_92 && _loc12_ == RoomPlaneBitmapMaskData.const_239)
                              {
