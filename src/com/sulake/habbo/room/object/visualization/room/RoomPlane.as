package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1368:int = 0;
      ...
      private var var_1061:Vector3d = null;
      ...
      private var var_928:IPlaneRasterizer = null;
      ...
      private var var_422:PlaneBitmapData = null;
      ...
      private var var_216:BitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1061 = new Vector3d();
         this.var_1061.assign(param1);
         ...
         this.var_275.assign(param4);
         this.var_558 = Vector3d.crossProduct(this.var_276,this.var_275);
         if(this.var_558.length > 0)
         {
            this.var_558.mul(1 / this.var_558.length);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_928.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_422;
         if(_loc3_ == null)
         {
         ...
         if(this.var_756 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_356))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_275.length * param1.scale;
            _loc7_ = param1.getCoordinatePosition(this.var_558);
            _loc4_ = this.getTextureIdentifier(param1.scale);
            ...
            if(this.var_928 != null)
            {
               _loc3_ = this.var_928.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1838,this.var_2607,this.var_2606,this.var_2608,this.var_2609,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1295.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1295[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1061);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_145.z - originZ,this.var_107.z - originZ,this.var_81.z - originZ,this.var_106.z - originZ);
            if(this._type == const_92)
            {
               relativeDepth += 0.02;
            }
            this.var_2236 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2610);
      ...
      {
         this.var_145.assign(param1.getScreenPosition(this.var_74));
         this.var_107.assign(param1.getScreenPosition(Vector3d.sum(this.var_74,this.var_275)));
         this.var_81.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_74,this.var_276),this.var_275)));
         this.var_106.assign(param1.getScreenPosition(Vector3d.sum(this.var_74,this.var_276)));
         this._offset = param1.getScreenPoint(this.var_1061);
         this.var_145.x = Math.round(this.var_145.x);
         this.var_145.y = Math.round(this.var_145.y);
         ...
         var _loc2_:Number = Math.min(this.var_145.x,this.var_107.x,this.var_81.x,this.var_106.x);
         var _loc3_:Number = Math.max(this.var_145.x,this.var_107.x,this.var_81.x,this.var_106.x);
         var _loc4_:Number = Math.min(this.var_145.y,this.var_107.y,this.var_81.y,this.var_106.y);
         var _loc5_:Number = Math.max(this.var_145.y,this.var_107.y,this.var_81.y,this.var_106.y);
         _loc3_ -= _loc2_;
         this._offset.x -= _loc2_;
         this.var_145.x -= _loc2_;
         this.var_107.x -= _loc2_;
         this.var_81.x -= _loc2_;
         this.var_106.x -= _loc2_;
         _loc5_ -= _loc4_;
         this._offset.y -= _loc4_;
         this.var_145.y -= _loc4_;
      ...
      {
         if(this.var_145 == null || this.var_107 == null || this.var_81 == null || this.var_106 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         ...
         if(this._type == const_120 || this._type == const_92)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_120 || this._type == const_92))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_927)
         {
            ...
            {
               _loc4_ = this.var_255[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_255.length == this.var_929.length)
         {
            while(_loc1_ < this.var_255.length)
            {
               _loc4_ = this.var_255[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_929.length)
                  {
                     _loc7_ = this.var_929[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_355.length > this.var_1426.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_927 || this.var_255.length == 0 && this.var_355.length == 0 && !this.var_356 || this.var_771 == null)
         {
            return;
         }
         ...
         if(this.var_356)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_558);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_255.length)
            {
               _loc3_ = this.var_255[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc3_.leftSideLoc / this.var_276.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc3_.rightSideLoc / this.var_275.length;
                  _loc12_ = _loc3_.type;
                  this.var_771.updateMask(this.var_66,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_929.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_355.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  _loc11_ = this.var_66.height - this.var_66.height * _loc4_.rightSideLoc / this.var_275.length;
                  _loc13_ = this.var_66.width * _loc4_.leftSideLength / this.var_276.length;
                  _loc14_ = this.var_66.height * _loc4_.rightSideLength / this.var_275.length;
                  this.var_66.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1426.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_356 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_216 != null && (this.var_216.width != param1.width || this.var_216.height != param1.height))
         {
            this.var_216.dispose();
            this.var_216 = null;
         }
         if(this.var_216 == null)
         {
            this.var_216 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_216.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_216.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_216,this.var_216.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
