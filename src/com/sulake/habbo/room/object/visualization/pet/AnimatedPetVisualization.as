package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_583:int = 1;
      
      private static const const_916:int = 1000;
      
      private static const const_1255:String = "pet_experience_bubble_png";
      
      private static const const_1254:int = 0;
      ...
      private var var_322:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_322 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_322.commonAssets != null)
         {
            _loc3_ = this.var_322.commonAssets.getAssetByName(const_1255) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_351);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_259);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_400) > 0;
            this.var_1546 = _loc3_.getNumber(RoomObjectVariableEnum.const_320);
            this.var_1268 = _loc3_.getNumber(RoomObjectVariableEnum.const_891);
            this.var_2067 = _loc3_.getNumber(RoomObjectVariableEnum.const_721);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1660)
            {
               this.var_1660 = _loc6_;
               this.var_2335 = this.var_1660.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1268 > 0)
            {
               _loc2_ = param1 - this.var_1268;
               if(_loc2_ < const_916)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_916 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_250 = param1;
            _loc3_ = this.var_322.getAnimationForPosture(var_183,param1);
            this.setAnimationForIndex(const_1254,_loc3_);
         }
         if(param2 != this.var_1267)
         {
            this.var_1267 = param2;
            _loc3_ = this.var_322.getAnimationForGesture(var_183,param2);
            this.setAnimationForIndex(const_1253,_loc3_);
         }
      }
      
      override protected function getAdditionalSpriteCount() : int
      {
         return super.getAdditionalSpriteCount() + const_583;
      }
      ...
      override protected function updateAnimations(param1:Number) : Array
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_109.length)
         {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2335);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_583)
         {
            _loc4_ = _data.getSize(param1);
            if(param2 < _loc3_ - (1 + const_583))
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_431.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_431[param2];
               if(_loc4_ == 1)
               {
