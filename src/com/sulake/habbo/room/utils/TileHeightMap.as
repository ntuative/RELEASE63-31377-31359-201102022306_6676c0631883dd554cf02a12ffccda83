package com.sulake.habbo.room.utils
{
   public class TileHeightMap
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < this.var_141 && param2 >= 0 && param2 < this.var_142)
         {
      ...
      public function getTileBlocking(param1:int, param2:int) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_141 && param2 >= 0 && param2 < this.var_142)
         {
            _loc3_ = this.var_804[param2] as Array;
      ...
      public function setTileBlocking(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < this.var_141 && param2 >= 0 && param2 < this.var_142)
         {
            _loc4_ = this.var_804[param2] as Array;
            _loc4_[param1] = param3;
         }
      }
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param4 > this.var_142)
         {
            return false;
         }
         if(param1 + param3 > this.var_141 || param2 + param4 > this.var_142)
         {
            return false;
         }
         ...
         if(param6 < 0 || param6 >= this.var_142)
         {
            param6 = 0;
         }
         ...
         if(param6 + param8 >= this.var_142)
         {
            param8 = this.var_142 - param6;
         }
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:* = null;
         ...
         {
            _loc11_ = this.var_804[_loc10_] as Array;
            _loc9_ = param1;
