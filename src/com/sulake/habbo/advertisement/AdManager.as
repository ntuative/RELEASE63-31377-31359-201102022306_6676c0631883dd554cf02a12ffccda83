package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1069:BitmapData = null;
      
      private var var_1070:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2268 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2270 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2269 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1628 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_206 != null && this.var_206.running)
         {
            this.var_206.reset();
            return false;
         }
         if(this.var_1068 == 0)
         {
            this.var_1068 = getTimer();
            return false;
         }
         if(this.var_1628 > 0 && this.var_1629 >= this.var_1628)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1068;
         if(_loc1_ > this.var_2270)
         {
            ++this.var_1629;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1310 = _loc2_.imageUrl;
         this.var_2271 = _loc2_.clickUrl;
         this.var_1068 = getTimer();
         if(this.var_1310 != "")
         {
            _loc3_ = this.var_1310;
            ...
            {
               this.var_206 = new Timer(this.var_2269,1);
               this.var_206.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_206.running)
            {
               this.var_206.reset();
            }
            this.var_206.start();
            _loc4_ = new URLRequest(this.var_1310);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_436,0,0,param1.bitmapData,this.var_2271));
            this.var_1068 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1311 = _loc2_.imageUrl;
         this.var_1627 = _loc2_.clickUrl;
         if(this.var_1311 != "" && this.var_1627 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1311);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_439,0,0,_loc4_,this.var_1627,this.var_1069,this.var_1070));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1069 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1070 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
