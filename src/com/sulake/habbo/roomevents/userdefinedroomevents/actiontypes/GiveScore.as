package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      {
         this.var_87 = param2;
         this.var_999 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_999.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_999.setValue(1);
         this.var_1165 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1165.addEventListener(Event.CHANGE,this.onCounterSliderChange);
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_999.setValue(_loc3_);
         this.var_1165.setValue(_loc4_);
      }
