package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1534:TriggerConfs;
      
      private var var_1533:ActionTypes;
      
      private var var_1532:ConditionTypes;
      ...
      {
         this.var_1534 = new TriggerConfs();
         this.var_1533 = new ActionTypes();
         this.var_1532 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.find(this.var_86,"helplink").mouseThreshold = 0;
         this.find(this.var_86,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1010 = new SliderWindowController(this.var_87,IWindowContainer(this.find(this.var_86,"delay_slider_container")),this.var_87.assets,0,20,1);
         this.var_1010.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1010.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_659.hideAll(this.var_233);
         }
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_60 as TriggerDefinition != null)
         {
            this.var_87.send(new UpdateTriggerMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_60 as ActionDefinition != null)
         {
            this.var_87.send(new UpdateActionMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_60 as ConditionDefinition != null)
         {
            this.var_87.send(new UpdateConditionMessageComposer(this.var_60.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1010.getValue()) : 0;
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_87.send(new ApplySnapshotMessageComposer(this.var_60.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1534);
         this.refreshConfigureElement(this.var_1533);
         this.refreshConfigureElement(this.var_1532);
