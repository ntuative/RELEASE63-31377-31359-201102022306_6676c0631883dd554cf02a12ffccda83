package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1705:String = "no_reqs_info";
      ...
      {
         this.var_1863 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1864 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1864.procedure = this.onDismissAllButtonClick;
         this.var_1863.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_160)
         {
         ...
         else if(param1.state == FriendRequest.const_378)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_1141)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_378;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_319,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_350 && _loc4_.state != FriendRequest.const_378)
            {
               _loc4_.state = FriendRequest.const_378;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_319,_loc4_.requestId));
               }
            }
         }
         this.refresh();
