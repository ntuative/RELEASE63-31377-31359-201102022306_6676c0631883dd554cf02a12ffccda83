package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1666:String = "noconvinfo";
      
      private static const const_1665:String = "messageinput";
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.FRIENDLIST,this.var_17));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_915 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_261 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1266.prepare(this.var_915);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1069,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1162,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_871,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_714,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_871,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_714,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1265 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1265.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1544 == -1 ? 0 : int(this.var_17.height - this.var_1544);
         var _loc4_:int = this.var_1542 == -1 ? 0 : int(this.var_17.width - this.var_1542);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_261.y = Util.getLowestPoint(this.var_17.content);
         this.var_261.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_871,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1069,false);
         ...
         this.var_1544 = this.var_17.height;
         this.var_1542 = this.var_17.width;
