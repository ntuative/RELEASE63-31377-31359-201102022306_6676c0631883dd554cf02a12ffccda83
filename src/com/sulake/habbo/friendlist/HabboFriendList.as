package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_152:String = "face";
      ...
      private var var_1083:IAvatarRenderManager;
      ...
      private var var_1792:AvatarSearchResults;
      
      private var var_178:IHabboToolbar;
      
      private var var_822:IHabboNotifications;
      ...
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1792 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_598.stop();
            this.var_598.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_598 = null;
         }
         ...
         if(this.var_1083)
         {
            this.var_1083.release(new IIDAvatarRenderManager());
            this.var_1083 = null;
         }
         if(this.var_822)
         {
            this.var_822.release(new IIDHabboNotifications());
            this.var_822 = null;
         }
         if(this.var_178)
         {
         ...
         if(this.var_744)
         {
            this.var_744.release(new IIDSessionDataManager());
            this.var_744 = null;
         }
         super.dispose();
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_350.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_178.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_285,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1083.createAvatarImage(param1,AvatarScaleType.const_83,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1083 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_178 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_822 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_1011,this.getText("friendlist.friends")));
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_339,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_598)
         {
            this.var_598 = new Timer(120000);
            this.var_598.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_598.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_94.findCategory(FriendCategory.const_339);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_416.findTab(FriendListTab.const_95).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_416.findTab(FriendListTab.const_95);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1792.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_416.findTab(FriendListTab.const_95);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_744 || !this.var_350)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_744.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_350.vipLimit;
         }
         else if(this.var_744.hasUserRight("fuse_extended_buddylist"))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_152) as IBitmapWrapperWindow;
