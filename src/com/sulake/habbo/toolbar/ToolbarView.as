package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1363:Number = 0;
      
      private var var_1742:Number = 15;
      
      private var var_1741:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2760 = new Array();
         ...
         this.var_211 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_56,HabboWindowStyle.const_1173,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1363 = _loc6_.toolbar.@margin_bottom;
         this.var_1742 = _loc6_.toolbar.@min_group_margin;
         this.var_1741 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_246,param1,param2,this._window,this.var_287);
         this.createGroupsFromXmlList(_loc8_,this.var_587,param1,param2,this.var_211,this.var_287);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,this._events,param5,param6,this.var_154);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_154,this.var_486,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_486);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_154,this.var_486);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_154,this.var_486);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_211.x = this.var_154 + this.var_1741;
               this.var_211.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_211.x = 0;
               this.var_211.y = this.var_154 + this.var_1741;
         ...
         else
         {
            ...
            if(this.var_246.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1742,(this._window.height - _loc5_ * _loc8_ - this.var_1114 - this.var_1363) / (this.var_246.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1742,(this._window.width - _loc5_ * _loc8_ - this.var_1114 - this.var_1363) / (this.var_246.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_246.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_486;
