package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1331:Number = 25;
      
      private static const const_1346:Number = 90;
      
      private static const const_950:int = 50;
      
      private static const const_1330:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1436:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_623 = new Object();
         this.var_622 = new Array();
         this.var_624 = new Array();
         super();
         this._windowManager = param1;
         this.var_1436 = param2;
         this.var_763 = new Timer(const_1331);
         this.var_763.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_362[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_950 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_950 || param1.desktop.height - param1.y < const_1330;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1436.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_362.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1436.getIconLoc(param1.iconId);
      ...
      {
         return this.var_622[this.var_624.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_624[this.var_622.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_362,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_251,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_623[_loc3_] == null)
            {
               this.var_623[_loc3_] = new Array();
            }
            if(this.var_623[_loc3_].indexOf(param1) < 0)
            {
               this.var_623[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_362.indexOf(param1) > -1)
         {
            if(const_206)
            {
            ...
            else
            {
               ...
               this.var_362.splice(this.var_362.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < this.var_622.length)
         {
            if(this.var_622[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_623[_loc3_].length)
                  {
                     this.repositionWindow(this.var_623[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_362.length)
         {
            _loc2_ = this._itemList[this.var_362[_loc7_]];
            if(_loc2_.active)
            {
