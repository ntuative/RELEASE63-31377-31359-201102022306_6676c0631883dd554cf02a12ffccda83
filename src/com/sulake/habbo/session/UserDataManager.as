package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1256:int = 1;
      
      private static const const_1257:int = 2;
      ...
      {
         var _loc3_:* = null;
         var _loc4_:Map = this.var_707.getValue(param2);
         if(_loc4_ != null)
         {
      ...
      public function setUserData(param1:IUserData) : void
      {
         ...
         var _loc2_:Map = this.var_707.getValue(param1.type);
         if(_loc2_ == null)
         {
            _loc2_ = new Map();
            this.var_707.add(param1.type,_loc2_);
         }
      ...
      public function removeUserDataByIndex(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_707.getValue(_loc2_.type);
            if(_loc3_ != null)
            {
