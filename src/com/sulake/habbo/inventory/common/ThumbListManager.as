package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1371:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_589 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_589.width;
         this.var_88 = this.var_589.height;
         this.var_1119 = param5;
         this.var_899 = param6;
         this.var_213 = Math.floor(this.var_1119 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1119,this.var_899);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_213 * this._thumbWidth,this.var_1119),Math.max(this.var_590 * this.var_88,this.var_899),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_213 && this.var_26.height < _loc3_.y * this.var_88)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_213 - 1),this.var_88);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_213 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_88),null,null,true);
         _loc4_ = new Rectangle(0,this.var_88,this._thumbWidth * (this.var_213 - 1),this.var_26.height - this.var_88);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1371.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_213));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_213 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_213);
         var _loc3_:int = param1 % this.var_213;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = this.var_213 - param1.x - 1;
         ...
         if(this.var_26.height < this.var_899)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_899);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_589.width,this.var_589.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_589.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_589,this.var_589.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
