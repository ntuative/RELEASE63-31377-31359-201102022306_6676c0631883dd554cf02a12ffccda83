package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2772:IWindowContainer;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_178 != null && this.var_1170)
         {
            this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1170 = false;
         }
         this._controller.inventoryViewOpened(this.var_759);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_758 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_178 != null && this.var_1170)
            {
               this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1170 = false;
            }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_758 == InventoryCategory.const_162)
            {
               this.toggleCategoryView(InventoryCategory.const_162);
            }
            else if(this.var_758 == InventoryCategory.const_80)
            {
