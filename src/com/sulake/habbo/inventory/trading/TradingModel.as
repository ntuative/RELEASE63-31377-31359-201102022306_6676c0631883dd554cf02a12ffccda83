package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1467:uint = 9;
      ...
      public static const const_293:uint = 3;
      
      public static const const_536:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_52.updateItemList(this.var_743);
         this.var_52.updateItemList(this.var_1399);
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_742 + " OTHER: " + this.var_1135);
         ...
         {
            case const_170:
               if(param1 == const_185 || param1 == const_241)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_294.length)
         {
            _loc2_ = this.var_294.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_52.alertPopup(TradingView.const_1017);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_743)
            {
               this.var_742 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1135 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_52.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_743)
            {
               this.var_52.alertPopup(TradingView.const_1175);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_294.length < const_1467)
         {
         ...
         else
         {
            ...
            if(this.var_294.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
