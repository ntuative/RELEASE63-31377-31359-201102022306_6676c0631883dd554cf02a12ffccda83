package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this._controller != null && this._controller.furniModel != null && this.var_223 != null)
         {
            this._controller.furniModel.removeLockFrom(this.var_223.id);
            this.var_223 = null;
         }
      }
      ...
      {
         if(this.var_223 != null || param1 == null)
         {
            return;
         }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_223 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_223.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_223 is FloorItem ? 1 : 2;
         this.var_2053 = _loc2_;
         this.var_2049 = this.var_223.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_223.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_223);
               break;
            case 2:
      ...
      {
         if(param1 != this.var_2053 || param2 != this.var_2049)
         {
            return;
         }
         if(!this._view)
