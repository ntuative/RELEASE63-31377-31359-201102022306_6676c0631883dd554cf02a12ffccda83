package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_338:String = "pets";
      
      private static const const_1210:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_214,this.onObjectPlaced);
         this._catalog = param7;
         this.var_535 = new Timer(const_1210,1);
         this.var_535.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_1997 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_214,this.onObjectPlaced);
               }
            ...
            {
               this.var_535.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_535.stop();
               this.var_535 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_361)
         {
         ...
         if(this.var_797 == null)
         {
            this.var_797 = this._windowManager.buildFromXML(this.var_1997) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_797.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_80 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_47:
                  ...
                  break;
               case const_338:
                  this._controller.toggleInventoryPage(InventoryCategory.const_162);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_402);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_439.add(const_42,new Array());
         this.var_439.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_321;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_367 || _loc3_.category == FurniCategory.const_361 || _loc3_.category == FurniCategory.const_369)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1236 && param1.type == RoomEngineObjectEvent.const_214)
         {
            this.var_1236 = false;
         }
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_848)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
