package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1124:IRoomSession;
      ...
      private const const_1972:int = 500;
      ...
      {
         return FurniModel(this.var_47.getValue(InventoryCategory.const_80));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_47.getValue(InventorySubCategory.const_321));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_47.getValue(InventoryCategory.const_857));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_47.getValue(InventoryCategory.const_304));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_47.getValue(InventoryCategory.const_386));
      }
      ...
      {
         return PetsModel(this.var_47.getValue(InventoryCategory.const_162));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_47.getValue(InventoryCategory.const_402) as MarketplaceModel;
      }
      ...
      {
         this.var_407 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_407 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_178)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_178);
         this.var_47 = new Map();
         ...
         this.var_47.add(InventoryCategory.const_402,_loc1_);
         ...
         this.var_47.add(InventoryCategory.const_80,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_407);
         this.var_47.add(InventoryCategory.const_304,_loc3_);
         ...
         this.var_47.add(InventoryCategory.const_857,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_407);
         this.var_47.add(InventoryCategory.const_386,_loc5_);
         ...
         this.var_47.add(InventorySubCategory.const_321,_loc6_);
         ...
         this.var_47.add(InventoryCategory.const_162,_loc8_);
         this.var_184 = true;
         if(this.var_2496)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_906.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_906.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_906.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1972);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_659));
      }
