package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_718,RoomWidgetEcotronBoxOpenMessage.const_639,RoomWidgetEcotronBoxOpenedMessage.const_1359];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_718:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_639:
