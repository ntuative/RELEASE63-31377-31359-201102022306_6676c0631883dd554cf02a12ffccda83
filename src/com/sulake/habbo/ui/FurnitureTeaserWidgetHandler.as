package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_616,RoomWidgetViralFurniMessage.const_712,RoomWidgetViralFurniMessage.const_149];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_616:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_479);
                     _loc7_.data = _loc6_;
                     this._container.events.dispatchEvent(_loc7_);
                  }
               }
               break;
            case RoomWidgetViralFurniMessage.const_712:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_501,RoomSessionViralFurniStatusEvent.const_426];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_501:
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_426:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
