   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_659,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_685,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_178 != null)
            {
               this.var_178.events.removeEventListener(HabboToolbarEvent.const_64,this.onHabboToolbarEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_659,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_685,this.onHabboClubSubscriptionChanged);
         }
         this.var_178 = this._container.toolbar;
         if(this.var_178 != null)
         {
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1410)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc4_.setDirection(AvatarSetType.const_46,3);
                  _loc1_ = _loc4_.getCroppedImage(AvatarSetType.const_46);
                  _loc4_.dispose();
               }
               this.var_1410 = _loc2_;
               this.var_1817 = _loc1_;
            }
            else
            {
         ...
         if(this.var_178 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_992,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_178.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_741);
         _loc1_.push(RoomWidgetDanceMessage.const_877);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_647);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_646);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_885);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_785);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_889);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_348);
         _loc1_.push(RoomWidgetStopEffectMessage.const_758);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1407);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_966);
         _loc1_.push(RoomWidgetToolbarMessage.const_733);
         _loc1_.push(RoomWidgetToolbarMessage.const_744);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_353);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1533);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1072);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_821);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_771);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_847);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1376);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_856);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_867);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_649);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_395);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_771:
               ...
               break;
            case RoomWidgetWaveMessage.const_741:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_877:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_647:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_646:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_885:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_348:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1062)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_889:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1159:
                        this._catalog.openCatalogPage(CatalogPageName.const_1495,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1119:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1430:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1632:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_758:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_965:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1650:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_966:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_821:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_733:
               ...
               if(this.var_178)
               {
                  this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_744:
               ...
               {
                  this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_534,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_353:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_557));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_847:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_856:
            ...
            case RoomWidgetStoreSettingsMessage.const_867:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_371,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_649:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_554));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_395:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_793));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_818));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_424:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_448));
         }
      }
