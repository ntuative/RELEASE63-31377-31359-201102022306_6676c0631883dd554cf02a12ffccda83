package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_610:Map = null;
      
      private var var_1826:Map = null;
      
      private var var_1161:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1162:Number = 0.0;
      
      private var var_753:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_420.length)
            {
               _loc2_ = this.var_420.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_827,RoomWidgetChatSelectAvatarMessage.const_768];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_827:
      ...
      {
         return [RoomSessionChatEvent.const_171];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_171:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_263)
                           {
                              _loc13_ = this.var_300.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_420.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_610.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_263:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_610.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_420.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1162 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1162);
            }
            if(this.var_753 == null)
            {
               ...
               this.var_504.y = 0;
               this.var_504.z = 0;
               this.var_753 = _loc4_.getScreenPoint(this.var_504);
               this.var_1162 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_504.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_753.x || _loc8_.y != this.var_753.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_753,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_420)
         {
            _loc2_ = this.var_420.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1161.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_610.add(param1,_loc7_);
                  }
               }
            }
         }
         ...
         {
            _loc8_ = 0;
            _loc9_ = this._container.roomEngine.getPetImage(_loc3_,_loc4_,new Vector3d(180),32,this,_loc8_);
            if(_loc9_ != null)
            {
               _loc2_ = _loc9_.data;
               if(_loc9_.id > 0)
               {
                  this.var_1826.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1826.remove(param1);
         if(_loc3_ != null)
         {
