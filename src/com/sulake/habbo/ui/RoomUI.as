package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1066:IRoomWidgetFactory;
      
      private var var_407:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_485:IAvatarRenderManager;
      ...
      private var var_1807:IHabboAvatarEditor = null;
      ...
      private var var_919:IHabboModeration;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_628:IHabboSoundManager;
      ...
      private var var_1152:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1409 = RoomDesktop.const_563;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1066.release(new IIDHabboRoomWidget());
            this.var_1066 = null;
         }
         ...
         {
            this.var_628.release(new IIDHabboSoundManager());
            this.var_628 = null;
         }
         ...
         {
            this.var_485.release(new IIDAvatarRenderManager());
            this.var_485 = null;
         }
         ...
         {
            this.var_919.release(new IIDHabboModeration());
            this.var_919 = null;
         }
         ...
         if(this.var_1152)
         {
            this.var_1152.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1152 = null;
         }
         this.var_1807 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1066 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_485 = param2 as IAvatarRenderManager;
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_178 = param2 as IHabboToolbar;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1807 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_298.events.addEventListener(AdEvent.const_430,this.adEventHandler);
            this.var_298.events.addEventListener(AdEvent.const_436,this.adEventHandler);
            this.var_298.events.addEventListener(AdEvent.const_439,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_919 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_919);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_628 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_171,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_419,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_132,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_477,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_428,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_501,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_426,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_695,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1120,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1179,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_645,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_772,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_197,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_835,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_708,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_514,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_128,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_122,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_499,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               if(param1.session != null)
               {
                  ...
                  this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.ZOOM));
                  this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.MEMENU));
                  this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      {
         this.var_1152 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_706,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_556,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_539,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_836,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_575,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_297,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_825,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_214,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_681,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_539 || param1.type == RoomEngineEvent.const_556)
         {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_627:
               ...
               if(this._roomEngine != null)
               {
                  ...
                  {
                     _loc7_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.ZOOM);
                     _loc7_.iconState = "2";
                     this.var_178.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_882);
               ...
               if(this.var_1409 != RoomDesktop.const_563)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_296,this.var_1409);
               }
               if(this.var_298 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_706:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1066;
         _loc3_.sessionDataManager = this.var_407;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_485;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_178;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1807;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_298;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1151;
         _loc3_.moderation = this.var_919;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_628;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1152;
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_689);
         _loc3_.init();
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_296);
            if(_loc3_ != RoomDesktop.const_563)
            {
               this.var_1409 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
