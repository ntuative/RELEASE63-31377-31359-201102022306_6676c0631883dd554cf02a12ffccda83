package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1179;
         if(this.var_1179 < this.var_943.length)
         {
            _loc1_ = this.var_943[this.var_1179] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_943.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_424)
         {
            ...
            this.var_424 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_424.center();
            this.var_424.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_943[this.var_1179] as Dictionary;
