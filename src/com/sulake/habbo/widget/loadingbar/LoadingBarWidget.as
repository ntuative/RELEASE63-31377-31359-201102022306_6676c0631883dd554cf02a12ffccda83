package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_468:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_468.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_468 = null;
         }
         if(this.var_43 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_280,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_280,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_468 == null)
         {
            this.var_468 = new Sprite();
            this.var_468.addChild(new Bitmap(this.var_43));
            this.var_468.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_468.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_43;
            }
         }
         _loc2_.setDisplayObject(this.var_468);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_280)
         {
            return;
         }
         if(this._window != null)
