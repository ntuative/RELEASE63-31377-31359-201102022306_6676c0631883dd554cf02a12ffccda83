package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_192:PetCommandTool;
      
      private var var_1325:Map;
      
      private var var_489:int;
      
      private const const_1958:int = 158;
      
      private const const_1961:int = 16;
      
      private const const_1954:uint = 11184810;
      
      private const const_1956:uint = 6710886;
      
      private const const_1957:uint = 3355443;
      
      private const const_1955:String = "level";
      
      private const const_1953:String = "experience";
      
      private const const_1960:String = "energy";
      
      private const const_1959:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1953,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1960,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1959,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_489 = param1.id;
         this.var_1325.remove(param1.id);
         this.var_1325.add(param1.id,param1);
         if(this.var_192 && this.var_192.isVisible() && param1.isOwnPet)
         {
            this.var_192.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_192.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1958,this.const_1961,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1954);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1957);
      ...
      private function openTrainView() : void
      {
         if(this.var_192 == null)
         {
            this.var_192 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1325.getValue(this.var_489) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_192.showWindow(true);
            this.var_192.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_192 && this.var_192.getPetId() == this.var_489)
               {
                  this.var_192.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_515,this._widget.petData.ownerId);
