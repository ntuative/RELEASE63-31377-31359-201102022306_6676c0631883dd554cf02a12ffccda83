package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_149:IFrameWindow;
      
      private var var_568:IWindow;
      
      private var var_207:IBorderWindow;
      
      private var var_1109:TagListRenderer;
      
      private var var_121:IBorderWindow;
      
      private var var_2344:int;
      
      private const const_918:int = 5;
      
      private const const_1679:int = 39;
      
      private const const_1677:int = 7829367;
      
      private const const_1678:int = 16777215;
      
      private const const_1966:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1109 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_50 == null || this.var_207 == null || this.var_65 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_207.width,this.var_65.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_207.width < this.var_65.width)
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_207.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_207.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_207.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_207.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_918;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc3_.textColor = this.const_1678;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_918;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_345,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_345,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1109.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_176);
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_176:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_254:
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1153:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1207:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2344 > this.const_1966 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2344 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1677;
            if(_loc3_.length >= this.const_1679)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1679 - 1);
            }
         }
      }
      ...
      {
         this.var_149 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_149.center();
         this.var_149.procedure = this.badgesEventProc;
         this.var_149.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_149 && this.var_149.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_568 = null;
         var _loc2_:IItemGridWindow = this.var_149.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_149.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_149.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_568);
               }
               if(_loc3_ <= -1)
               {
                  return;
