package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      {
         super();
         this.var_196 = new Timer(1000);
         this.var_196.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_196.stop();
            this.var_196.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_196 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_810 != null)
         {
            if(this.var_166.isActive)
            {
               ...
               this.var_810.width = _loc2_ * this.var_281;
            }
            else
            {
               this.var_810.width = 0;
               this.var_196.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_808 = this._window.findChildByName("effect_hilite");
            this.var_808.visible = false;
         }
         this.var_809 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_810 = this._window.findChildByName("loader_bar");
         if(this.var_810 != null)
         {
            this.var_281 = this.var_810.width;
            this.var_196.start();
            this.onUpdate();
         }
