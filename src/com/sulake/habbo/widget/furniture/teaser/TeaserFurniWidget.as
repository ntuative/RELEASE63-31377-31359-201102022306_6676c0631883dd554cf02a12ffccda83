package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1702:int = 0;
      
      private const const_1701:int = 1;
      
      private const const_1699:int = 2;
      
      private const const_1697:int = 3;
      
      private const const_1700:int = 4;
      
      private const const_1985:int = 0;
      
      private const const_1983:int = 1;
      
      private const const_1978:int = 2;
      
      private const const_1982:int = 3;
      
      private const const_1979:int = 4;
      
      private const const_1981:int = 5;
      
      private const const_1703:String = "deco_img";
      
      private const const_1698:String = "dialog_bg";
      
      private const const_1984:String = "%campaign%_dialog_bg.png";
      
      private const const_326:String = "%campaign%_gift_package.png";
      
      private const const_1980:String = "%campaign%_gift_content.png";
      
      private const const_1986:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         this._imageUrlPath = this.var_129.getKey("image.library.url","http://images.habbo.com/c_images/");
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_479,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_479,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_479:
         ...
         if(this._window && (this.var_1429 != _loc2_ || _loc3_ != this.var_161))
         {
         ...
         if(!this._window)
         {
            switch(this.var_1429)
            {
               case this.const_1702:
                  ...
                  _loc2_ = this.const_326;
                  this.sendConversionPoint("viral_" + this.var_161,"client.show.teaser");
                  break;
               case this.const_1701:
                  if(this.var_372 == this.const_1985)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_locked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_161,"client.show.locked");
                     _loc2_ = this.const_326;
                  }
                  else if(this.var_372 == this.const_1983)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_unlocked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_161,"client.show.unlocked");
                     _loc2_ = this.const_1980;
                  }
                  else if(this.var_372 == this.const_1978)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_161,"client.show.no_fb");
                  ...
                  else if(this.var_372 == this.const_1982)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_161,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_372 == this.const_1979)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_161,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_372 == this.const_1981)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_161,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_1984.replace("%campaign%",this.var_161);
            this.setDecoImage(_loc5_,this.const_1698);
            _loc2_ = _loc2_.replace("%campaign%",this.var_161);
            this.setDecoImage(_loc2_,this.const_1703);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_712);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_161,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_161,"client.start_post");
         var _loc4_:String = this.var_129.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_161,_loc2_,_loc3_,this.var_1431,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         this.hideInterface();
         this.sendConversionPoint("viral_" + this.var_161,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_876,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1430.push(new ImageDownloader(this,_assets,this.var_161,this._imageUrlPath,param1,param2));
            return;
         }
      ...
      {
         if(!this._window || this.var_161 != param1.campaignID)
         {
            return;
         }
