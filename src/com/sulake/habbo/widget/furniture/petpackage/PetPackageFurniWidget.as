package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_564,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_564,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_421:
               ...
               this.var_585 = event.figure;
               this.showInterface();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_564:
               if(!this.var_1157)
               {
                  return;
               }
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("petpackage_container","",HabboWindowType.const_56,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1230,const_1229,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc2_:* = null;
         if(this.var_1157 || this._objectId == -1)
         {
            return;
         }
         ...
         {
            this.var_1157 = true;
            _loc2_ = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_778,this._objectId,_loc1_);
