package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_570:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1230,const_1229,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_570 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1337 = _loc2_.light;
         if(this.var_399 != null)
         {
            this.var_399.setValue(this.var_1337);
         }
         this.var_509 = this.colors.indexOf(_loc2_.color);
         if(this.var_570 != null)
         {
            this.var_570.setSelectedColorIndex(this.var_509);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1336 = XML(_loc1_.content);
         return this.var_1336;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_570 != null)
         {
            this.var_570.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
