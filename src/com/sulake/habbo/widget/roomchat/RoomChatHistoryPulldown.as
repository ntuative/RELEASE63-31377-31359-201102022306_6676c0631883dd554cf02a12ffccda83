package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_944:int = 150;
      
      private static const const_943:int = 250;
      ...
      private var var_2556:BitmapData;
      
      private var var_2554:BitmapData;
      
      private var var_2555:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_38 = param3;
         this.var_2558 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1811 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2557 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1813 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1812 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2556 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2554 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_73 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_285,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,param3.width,param3.height - const_81),null,0,0) as IBitmapWrapperWindow;
         this.var_38.addChild(this.var_73);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_56,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_38.height - const_81,param3.width,const_81),null,0) as IWindowContainer;
         this.var_38.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_660,HabboWindowStyle.const_39,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_81),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_523:
               this.var_73.blend += param1 / const_943;
               this._window.blend += param1 / const_943;
               ...
               break;
            case const_901:
               this.var_73.blend -= param1 / const_944;
               this._window.blend -= param1 / const_944;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_38.width - this.var_2555;
         }
         if(this.var_73 != null)
         {
            this.var_73.rectangle = this.var_38.rectangle;
            this.var_73.height -= const_81;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2559 == this._window.width)
         {
            return;
         }
         this.var_2559 = this._window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2558,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1811,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1811,_loc9_);
         ...
         this.var_73.bitmap = this.var_2554;
