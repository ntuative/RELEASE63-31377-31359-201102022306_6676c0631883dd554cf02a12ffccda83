package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1319:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_176.state = RoomChatHistoryPulldown.const_228;
         ...
         this.var_46 = param2.createWindow("chatscroller","",HabboWindowType.const_1190,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_176.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_228);
      }
      ...
      {
         return !!this.var_414 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_176.state == RoomChatHistoryPulldown.const_384 || this.var_176.state == RoomChatHistoryPulldown.const_523;
      }
      ...
      {
         if(!this.var_414 && !this.var_1723)
         {
            this.var_414 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_176.state = RoomChatHistoryPulldown.const_384;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_46 != null)
         {
            ...
            if(param2)
            {
               this.var_46.scrollV = this.var_601;
            }
         }
         if(this.var_176 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_415 > 0 && param2)
         {
            if(this.var_1797)
            {
               if(Math.abs(param1 - this.var_415) <= const_967)
               {
                  return;
               }
               this.var_1797 = false;
            ...
            if(this.var_414)
            {
               ...
               _loc5_ = (param1 - this.var_415) / this.var_46.height;
               _loc3_ = this.var_601 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_415;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_46.scrollV < 1 - const_1319 / this.var_46.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1796)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_46 != null)
         {
            this.var_601 = this.var_46.scrollV;
         }
         if(this.var_46 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_601 - this.var_46.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
