package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1349:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1465:XML;
      
      private static var var_1467:XML;
       
      
      private var var_1921:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2779:IWindowContainer;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1467 == null)
         {
            ...
            var_1467 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1921 == 4294967295)
            {
               this.var_1921 = _loc1_.color;
            }
            _loc1_.color = const_1349;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1353;
            }
         }
      }
      ...
      {
         this.var_56 = navigator.catalog.windowManager.buildFromXML(var_1467) as IItemListWindow;
         if(this.var_56 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1465) as IWindowContainer;
         }
         else
         {
