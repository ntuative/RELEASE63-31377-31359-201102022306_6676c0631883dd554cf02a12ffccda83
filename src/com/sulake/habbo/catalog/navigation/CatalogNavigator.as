package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2807:String = "magic.credits";
      
      private var var_2778:String = "magic.pixels";
      
      private var var_2777:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2778);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2777,true);
      }
