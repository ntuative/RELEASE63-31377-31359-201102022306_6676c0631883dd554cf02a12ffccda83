package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1973:int = 10;
      ...
      private const const_1672:uint = 4.293848814E9;
      
      private const const_1673:uint = 4.294967295E9;
      
      private const const_1974:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_257:
                  ...
                  break;
               case ProductTypeEnum.const_328:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1691 = _loc1_.stuffTypes;
            this.var_738 = _loc1_.boxTypes;
            this.var_737 = _loc1_.ribbonTypes;
            this.var_1133 = this.var_1691[0];
            this.var_348 = this.var_738[0];
            this.var_347 = this.var_737[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_347 < 0)
         {
            this.var_347 = this.var_737.length - 1;
         }
         if(this.var_347 > this.var_737.length - 1)
         {
            this.var_347 = 0;
         }
         if(this.var_348 < 0)
         {
            this.var_348 = this.var_738.length - 1;
         }
         if(this.var_348 > this.var_738.length - 1)
         {
            this.var_348 = 0;
         }
         var _loc1_:int = this.var_738[this.var_348] * 1000 + this.var_737[this.var_347];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_89.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1133,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1396 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1691;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1133);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_738[this.var_348]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_737[this.var_347]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_89,this.var_1395,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_89.offerId,this.var_1395);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               if(this.var_2507 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_218)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1973)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2507 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_345:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_596 == null)
         {
            this.var_596 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_596.procedure = this.method_12;
         }
         if(this.var_252 == null || this.var_596 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_596.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1974;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1672) : uint(this.const_1673);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1133;
               }
            }
            _loc4_++;
         }
