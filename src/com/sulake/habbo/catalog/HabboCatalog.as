package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_363:CatalogViewer;
      
      private var var_364:ICatalogNavigator;
      ...
      private var var_2676:GiftWrappingConfiguration;
      
      private var var_1186:ClubGiftController;
      
      private var var_514:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_221.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_514.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_364.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_407.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_407.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_84)
         {
            _loc3_ = this.var_407.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_101.getActivityPointsForType(Purse.const_183)));
         var _loc1_:int = 0;
      ...
      {
         this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_747)
         {
            if(!this.var_407.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_178 != null && _loc2_)
         {
            this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_363.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_364 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_363 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_363.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_253,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_91:
               this.var_1888 = param1.session.isPrivateRoom;
               if(this.var_90 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1186 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_514 == null)
         {
            this.var_514 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_364.buildCatalogIndex(_loc2_);
         if(this.var_769 && this.var_769 != "")
         {
            this.var_364.openPage(this.var_769);
            this.var_769 = "";
            this.var_951 = -1;
         }
         else if(this.var_951 > -1)
         {
            this.var_364.openPageById(this.var_951,this.var_1889);
            this.var_951 = -1;
            this.var_1889 = -1;
            this.var_769 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_363.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_363.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2678 && this.var_628 != null)
         {
            this.var_628.playSound(HabboSoundTypesEnum.const_1203);
         }
         this.var_2678 = false;
         if(this.var_304 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_72,this.var_101.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2677 && this.var_628 != null)
         {
            this.var_628.playSound(HabboSoundTypesEnum.const_1077);
         }
         this.var_2677 = false;
         if(this.var_304 != null)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_99,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_99,_loc2_.points["null"]));
         }
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1186.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_363.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2676 = new GiftWrappingConfiguration(param1);
      }
