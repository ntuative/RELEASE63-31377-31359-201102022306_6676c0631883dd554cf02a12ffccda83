package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1876:IProductData;
      ...
      {
         super();
         this.var_1874 = param1.productType;
         this.var_1875 = param1.furniClassId;
         this.var_1442 = param1.extraParam;
         this.var_1441 = param1.productCount;
         this.var_1877 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_84:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1442);
               break;
