package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1213:Array = ["ctlg_header_img","ctlg_teaserimg_1","ctlg_special_img","ctlg_teaserimg_2","ctlg_teaserimg_3"];
      ...
      private static const const_895:Object = {"frontpage3":[7,8]};
      
      private static const const_896:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_647.length)
         {
            _loc2_ = String(this.var_647[param1]).replace("#","0x");
