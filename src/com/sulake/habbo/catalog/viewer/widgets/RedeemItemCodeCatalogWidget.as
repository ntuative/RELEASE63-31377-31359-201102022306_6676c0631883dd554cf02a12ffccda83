package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1100.removeEventListener(WindowKeyboardEvent.const_163,this.windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         this.var_1100 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1100 != null)
         {
            this.var_1100.addEventListener(WindowKeyboardEvent.const_163,this.windowKeyEventProcessor);
         }
      }
