package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IGetImageListener
   {
      ...
      private var var_555:BitmapData = null;
      
      private var var_1049:BitmapData = null;
      ...
      {
         super(param1);
         this.var_555 = new BitmapData(16,16,true,0);
         this.var_555.fillRect(new Rectangle(2,2,12,12),4278190080);
         this.var_1049 = new BitmapData(16,16,true,4278190080);
      }
      ...
      override public function init() : void
      {
         ...
         this.var_837 = this.getPetTypeIndexFromProduct(_loc3_.localizationId);
         this.initializePetImages();
         this._offers.add(this.var_837,_loc3_);
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_795,this.onApproveNameResult);
      ...
      private function initializePetImages() : void
      {
         ...
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc3_ = _loc2_.avatarRenderManager.petDataManager.getPetData(this.var_837,this);
               if(_loc3_)
               {
                  this.var_615 = _loc3_.sellableBreeds;
               }
            }
         }
         var _loc1_:int = 0;
         while(_loc1_ < const_1242)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc4_.id = _loc1_;
               if(_loc1_ == this.var_463)
               {
                  _loc5_.copyChannel(this.var_555,this.var_555.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
               }
               else
               {
                  _loc5_.copyChannel(this.var_555,this.var_555.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
                  _loc5_.copyChannel(this.var_1049,this.var_1049.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
               }
            }
            _loc1_++;
         }
      ...
      private function onPaletteEntryClick(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = window.findChildByName("palette_" + this.var_463) as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap.copyChannel(this.var_1049,this.var_1049.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
               _loc3_.invalidate();
            }
            _loc2_.bitmap.copyChannel(this.var_555,this.var_555.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.ALPHA);
            _loc2_.invalidate();
            this.var_463 = _loc2_.id;
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_837,this.var_463),this.getRaceLocalizationKey(this.var_837,this.var_463));
            }
         }
         return this.getRaceLocalizationKey(this.var_837,this.var_463);
      }
      ...
      private function updateImage() : void
      {
         ...
         var _loc2_:IBreed = this.var_615[this.var_463] as IBreed;
         if(!_loc2_)
         {
            return;
         }
         var _loc4_:int = this.var_463;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var breed:IBreed = this.var_615[this.var_463] as IBreed;
