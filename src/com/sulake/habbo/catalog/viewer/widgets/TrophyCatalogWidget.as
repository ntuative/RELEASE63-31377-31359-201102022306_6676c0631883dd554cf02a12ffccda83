   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_253.getValue(_loc5_) == null)
            {
               this.var_253.add(_loc5_,new Map());
            }
            _loc7_ = this.var_253.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_253.getWithIndex(this.var_293);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_739);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_253.getWithIndex(this.var_293);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_739);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_293;
         if(this.var_293 >= this.var_253.length)
         {
            this.var_293 = 0;
         }
         var _loc2_:Map = this.var_253.getWithIndex(this.var_293);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_293 < 0)
         {
            this.var_293 = this.var_253.length - 1;
         }
         var _loc2_:Map = this.var_253.getWithIndex(this.var_293);
         if(_loc2_ != null)
         {
