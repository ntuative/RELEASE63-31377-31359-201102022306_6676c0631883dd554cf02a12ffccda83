package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_571[this.var_1086][this.var_1683];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1086 = var_1230.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1086];
         var _loc3_:Array = this.var_571[this.var_1086] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1683 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1683] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_438 || _loc1_.pricingModel == Offer.const_455)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_84 || _loc3_.productType == ProductTypeEnum.const_88)
                  {
