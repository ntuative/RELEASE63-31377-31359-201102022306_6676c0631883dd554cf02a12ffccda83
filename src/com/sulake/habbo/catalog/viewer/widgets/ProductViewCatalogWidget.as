package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1435:IScrollbarWindow;
      ...
      {
         this.var_938 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         this.var_1866 = new Point(this.var_84.x,this.var_84.y);
         this.var_512 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1435 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1865 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_938.text = _loc4_;
         this.var_1174.text = _loc5_;
         this.var_938.height = this.var_938.textHeight + 5;
         this.var_1174.y = this.var_938.y + this.var_938.height;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_460:
                  _loc6_ = this.var_1865.clone();
                  if(this.var_512 != null)
                  {
                     this.var_512.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_512,this.var_1435,this.var_1721);
                     ...
                     case ProductTypeEnum.const_257:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_286,AvatarAction.const_541);
                              _loc16_.appendAction(AvatarAction.const_314,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2640)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2640 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1866.x;
            this.var_84.y = this.var_1866.y;
            if(param3 != null)
            {
