package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1187:ITextFieldWindow;
      ...
      {
         super.init();
         this.var_1187 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_1187 != null)
         {
            this.var_1187.addEventListener(WindowKeyboardEvent.const_345,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_1187.text));
      }
   }
}
