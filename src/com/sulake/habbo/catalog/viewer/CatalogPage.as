package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1655:String = "ctlg_";
       
      
      protected var var_1974:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1107:ICatalogViewer;
      ...
      private var var_1322:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1321:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1322 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1076);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1076);
      }
      ...
      public function dispose() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_53)
         {
            _loc1_.dispose();
         }
         this.var_53 = null;
      ...
      {
         var _loc2_:String = const_1655 + param1;
         ...
         this.var_1974 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1974) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         this.var_53.push(new LocalizationCatalogWidget(this._window));
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1540) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_1321 = new ItemGridCatalogWidget(_loc1_);
            this.var_53.push(this.var_1321);
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1364) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new ItemGroupCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1560) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new ProductViewCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1381) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new SingleViewCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1630) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new PurchaseCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1478) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new PurseCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1575) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new ColourGridCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1596) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new TraxPreviewCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1410) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new RedeemItemCodeCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1543) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new SpacesCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1416) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new TrophyCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1619) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new PetsCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1363) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new NewPetsCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1615) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new BotCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1392) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new TextInputCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1431) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new SpecialInfoWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1500) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new RecyclerCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1616) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new RecyclerPrizesCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1518) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new MarketPlaceCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1539) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new MarketPlaceOwnItemsCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1629) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new ClubGiftWidget(_loc1_,this._catalog.getClubGiftController()));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1559) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new ClubBuyCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1627) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_53.push(new ActivityPointDisplayCatalogWidget(_loc1_));
         }
         for each(_loc2_ in this.var_53)
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1322;
            _loc2_.init();
         }
         this.var_1322.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1322.dispatchEvent(param1);
      }
   }
}
