package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_905:int = 60;
      
      private static const const_904:int = 3600;
      
      private static const const_903:int = 86400;
      
      private static const const_902:int = 31536000;
      ...
      {
         if(param1 < 2 * const_905)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_904)
         {
            return Math.round(param1 / const_905) + " mins ago";
         }
         if(param1 < 2 * const_903)
         {
            return Math.round(param1 / const_904) + " hours ago";
         }
         if(param1 < 2 * const_902)
         {
            return Math.round(param1 / const_903) + " days ago";
         }
         return Math.round(param1 / const_902) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1002.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_33.getXmlWindow("user_info"));
            this.var_1002.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_33,WindowTracker.const_1032,this._data.userId),this._callerFrame,this.var_1003,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new RoomVisitsCtrl(this.var_33,this._data.userId),this._callerFrame,this.var_1003,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new SendMsgsCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1292),this._callerFrame,this.var_1003,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ModActionCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1292),this._callerFrame,this.var_1003,false,true);
      }
