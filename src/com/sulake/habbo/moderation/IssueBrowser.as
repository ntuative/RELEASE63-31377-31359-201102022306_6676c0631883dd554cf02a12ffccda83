package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1990:String = "my_issues";
      
      private const const_1989:String = "open_issues";
      
      private const const_1988:String = "picked_issues";
      
      private const const_1997:String = "closed_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_361.view.width = this.var_258.container.width;
         this.var_361.view.height = this.var_258.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1990:
               ...
               {
                  this.var_1857 = new MyIssuesView(this.issueManager,this,this.var_258.container);
               }
               return this.var_1857;
            case this.const_1989:
               if(this.var_1856 == null)
               {
                  this.var_1856 = new OpenIssuesView(this.issueManager,this,this.var_258.container);
               }
               return this.var_1856;
            case this.const_1988:
               if(this.var_1855 == null)
               {
                  this.var_1855 = new PickedIssuesView(this.issueManager,this,this.var_258.container);
               }
