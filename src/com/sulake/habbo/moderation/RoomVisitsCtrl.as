package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_858:Array = [];
      
      private static var var_1652:int = 200;
      ...
      {
         this.var_703 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1577;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_858.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_703.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_858.length < var_1652)
         {
            ...
            param1.width = this.var_703.width;
            param1.height = this.var_703.height;
            var_858.push(param1);
         }
         else
         {
