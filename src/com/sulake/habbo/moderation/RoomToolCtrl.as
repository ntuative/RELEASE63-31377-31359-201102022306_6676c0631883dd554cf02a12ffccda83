package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_957:ICheckBoxWindow;
      
      private var var_1457:ICheckBoxWindow;
      
      private var var_1458:ICheckBoxWindow;
      ...
      {
         return WindowTracker.const_1455;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_957 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1457 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1458 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_33,WindowTracker.const_632,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_957.isSelected);
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1643,_loc2_,this.var_464.text,"",""));
         if(this.var_1457.isSelected || this.var_1458.isSelected || this.var_957.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1457.isSelected,this.var_1458.isSelected,this.var_957.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1558);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1032.selection];
         if(_loc3_ != null)
         {
            this.var_544 = false;
            this.var_464.text = _loc3_;
         }
      }
   }
}
