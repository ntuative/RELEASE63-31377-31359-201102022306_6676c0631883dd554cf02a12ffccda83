package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_759:String = "issue_bundle_my";
      
      public static const const_1137:String = "issue_bundle_picked";
      
      public static const const_1545:int = 15000;
       
      
      private var var_63:ModerationManager;
      
      private var var_579:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_579 = new IssueBrowser(this,this.var_63.windowManager,this.var_63.assets);
         this.var_1106 = [];
         this.var_1105 = [];
         this.var_875 = new Map();
         this.var_2418 = parseInt(this.var_63.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1720 = new Timer(const_1545,0);
         this.var_1720.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1720.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1106 = this.var_1106.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_160 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_63.soundManager.playSound(HabboSoundTypesEnum.const_1113);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1618)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         if(this.var_1106.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_160)
         {
            _loc6_ = this.getBundles(const_759);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1105.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      {
         var _loc2_:IssueHandler = this.var_875.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_875.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_97)
         {
            ...
            {
               case const_1150:
                  if(_loc4_.state == IssueMessageData.const_160)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_875.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_875.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_370 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_875.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
