package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_727:IssueMessageData = null;
      
      private var var_728:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2468 = param2.pickerUserId;
         this.var_2467 = param2.pickerUserName;
         this.var_1357 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1120 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1121;
         }
         if(this.var_727 == null || param1.timeStamp < this.var_727.timeStamp)
         {
            this.var_727 = param1;
         }
         if(this.var_728 == null || param1.priority > this.var_728.timeStamp)
         {
            this.var_728 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_728;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_727;
         if(_loc2_ == null)
         {
