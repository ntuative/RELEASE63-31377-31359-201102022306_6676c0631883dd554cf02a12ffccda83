package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1051:IDropMenuWindow;
      
      private var var_464:ITextFieldWindow;
      
      private var _disposed:Boolean;
      
      private var var_544:Boolean = true;
      
      private var var_838:OffenceCategoryData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1052 = IButtonWindow(this.var_33.getXmlWindow("modact_offence"));
         this.var_1050 = IButtonWindow(this.var_33.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1573;
         ...
         this.var_464 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_464.procedure = this.onInputClick;
         this.var_1051 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1051);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_838 != null;
         ...
         else if(this.var_838 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_838.offences,this.var_1052,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_33.initMsg.offenceCategories,this.var_1050,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModAlertMessageComposer(this.var_1293,this.var_464.text,this.var_1292));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_838 = this.var_33.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_839 = this.var_838.offences[_loc3_];
         this.var_464.text = this.var_839.msg;
         this.var_544 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModKickMessageComposer(this.var_1293,this.var_464.text,this.var_1292));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1051.selection < 0)
         {
            this.var_33.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_33.connection.send(new ModBanMessageComposer(this.var_1293,this.var_464.text,this.getBanLength(),this.var_1292));
         this.dispose();
      }
      
      private function isMsgGiven() : Boolean
      {
         if(this.var_544 || this.var_464.text == "")
         {
      ...
      {
         var _loc1_:int = this.var_1051.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1052.destroy();
            this.var_1052 = null;
         }
         if(this.var_1050 != null)
         {
            this.var_1050.destroy();
            this.var_1050 = null;
         }
         this.var_1051 = null;
         this.var_464 = null;
