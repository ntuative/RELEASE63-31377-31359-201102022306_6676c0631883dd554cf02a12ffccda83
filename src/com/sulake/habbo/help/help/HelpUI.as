package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1681:int = 0;
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102022301));
         this.var_178 = param5;
         this.var_96 = new Map();
         this.var_96.add(HabboHelpViewEnum.const_1366,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_182,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_96.add(HabboHelpViewEnum.const_213,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_738,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_403,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_698,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_247,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_96.add(HabboHelpViewEnum.const_1067,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_96.add(HabboHelpViewEnum.const_1020,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_703,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_478.length == 0 || param1 != this.var_336)
            {
               this.var_478.push(this.var_336);
            }
         }
         this.var_336 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_247:
               this.showUI(HabboHelpViewEnum.const_247);
               break;
            case CallForHelpResultEnum.const_1098:
               this.showUI(HabboHelpViewEnum.const_1020);
               break;
            case CallForHelpResultEnum.const_976:
               this.showUI(HabboHelpViewEnum.const_1067);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_96.getValue(HabboHelpViewEnum.const_182) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_453));
      }
      ...
      {
         return this.var_96.getValue(this.var_336);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1692 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1693;
         this._window.width = _loc1_.width + this.var_1692;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_478.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_336 == HabboHelpViewEnum.const_182)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_335.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_336 == HabboHelpViewEnum.const_182 || this.var_478.length == 0)
         {
            return;
         }
         if(this.var_335 == null)
         {
            ...
            this.var_335 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_335.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_335.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_335 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_335 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_335 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
