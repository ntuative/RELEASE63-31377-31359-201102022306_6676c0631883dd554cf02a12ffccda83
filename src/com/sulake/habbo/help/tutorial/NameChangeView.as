package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1319:uint = 13232628;
      ...
      private var var_1074:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1636 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_701)
         {
            this.var_701 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_701)
            {
               return;
            }
            this._window.content.addChild(this.var_701);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_702)
         {
            this.var_702 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_702)
            {
               return;
            }
            this._window.content.addChild(this.var_702);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_702.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_471;
         }
         this.showView(this.var_702);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_471);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_970:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_971:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_971 || param1 == ChangeUserNameResultMessageEvent.var_970)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1074 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1074.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1319;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_471 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_471);
               break;
