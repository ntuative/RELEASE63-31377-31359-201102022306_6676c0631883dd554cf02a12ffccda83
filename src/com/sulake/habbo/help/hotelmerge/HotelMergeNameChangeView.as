package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_701)
         {
            this.var_701 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_701)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_702)
         {
            this.var_702 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_702)
            {
               return;
            }
