package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1886 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2672 = parseInt(_loc2_,16);
         this.var_2674 = parseInt(_loc3_,16);
         ...
         this.var_1862 = new ColorTransform(this.var_1505,this.var_1506,this.var_1507,this._alphaMultiplier);
         this.var_1185 = this.generatePaletteMapForGrayscale(this.var_2674,this.var_2672);
      }
      ...
      {
         return this.var_1185.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1185.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1185.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1185.getValue("alphas") as Array;
      }
