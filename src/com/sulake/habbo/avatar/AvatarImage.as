package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1238:String = "Default";
      
      private static const const_1237:int = 2;
      
      private static const const_1239:String = AvatarSetType.const_34;
      ...
      protected var var_265:IActiveActionData;
      
      protected var var_713:Boolean;
      ...
      protected var var_585:AvatarFigureContainer;
      
      protected var var_522:IAvatarDataContainer;
      
      protected var var_307:Array;
      
      protected var var_43:BitmapData;
      
      private var var_949:IActiveActionData;
      ...
      protected var var_1216:Boolean = false;
      ...
      private var var_2152:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1239,const_1237);
         this.var_307 = new Array();
         this.var_949 = new ActiveActionData(AvatarAction.const_376);
         this.var_949.definition = this._structure.getActionDefinition(const_1238);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_585,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1563;
         ...
         if(param1 == AvatarSetType.const_46 || param1 == AvatarSetType.const_34)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_542,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_234.length == 1 && this.var_85 == this.var_1968)
         {
            return this.var_85 + this.var_454 + this.var_542 % 4;
         }
         if(this.var_234.length == 2)
         {
            for each(_loc1_ in this.var_234)
            {
               ...
               {
                  return this.var_85 + this.var_454 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_542 % 11;
                  return this.var_85 + "_" + this.var_1968 + this.var_454 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2154 || param2 != this.var_2152 || param1 != this.var_2153)
         {
            this.var_2154 = param3;
            this.var_2152 = param2;
            this.var_2153 = param1;
            this.var_1562 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_265.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1216 || this.var_43 == null || (this.var_43.width != _loc5_.width || this.var_43.height != _loc5_.height))
         {
            if(this.var_43 != null && !this.var_1216)
            {
               this.var_43.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_265.definition.geometryType,this.var_85);
         this.var_43.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_542);
         ...
         {
            if(this.var_522.paletteIsGrayscale)
            {
               ...
               this.var_43 = _loc13_;
               this.var_43.paletteMap(this.var_43,this.var_43.rect,new Point(0,0),this.var_522.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_265.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_265.definition.geometryType,this.var_85);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_542);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_307.push(new ActiveActionData(param1,param2,this.var_542));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_265 = this.var_949;
         this.var_265.definition = this.var_949.definition;
         this.resetBodyPartCache(this.var_949);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_454 = "";
         this.var_234 = this._structure.sortActions(this.var_307);
         if(this.var_234 == null)
         {
            this.var_715 = new Array(0,0,0);
            if(this.var_1279 != "")
            {
               _loc1_ = true;
               this.var_1279 = "";
         ...
         {
            this.var_715 = this._structure.getCanvasOffsets(this.var_234,this._scale,this.var_85);
            for each(_loc4_ in this.var_234)
            {
               this.var_454 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_314)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1280 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1279 != this.var_454)
            {
               _loc1_ = true;
               this.var_1279 = this.var_454;
            }
         }
         this.var_1278 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_234)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_950 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_191 = this.var_191.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1563 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_522 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_294 || _loc1_.actionType == AvatarAction.const_225 || _loc1_.actionType == AvatarAction.const_335)
               {
                  this.var_950 = true;
               }
            }
