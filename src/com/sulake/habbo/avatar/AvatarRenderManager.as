package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1968:String = "hd-99999-99999";
      ...
      private var var_1681:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_599 = RenderMode.const_1496;
         this.var_285 = new Map();
         this.var_95 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_117,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_95.add(AvatarType.const_117,_loc4_);
         ...
         this.var_95.add(AvatarType.const_71,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_286.init();
         this.var_709.init();
         _loc2_ = this.var_95.getValue(AvatarType.const_117) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_95.getValue(AvatarType.const_71) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_95.getValue(AvatarType.const_117) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_878)
         {
            if(this.var_2362 && this.var_2361 && this.var_2363)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_95.getValue(AvatarType.const_117) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1681)
         {
            this.var_1681 = new AvatarFigureContainer(this.const_1968);
         }
         this.var_209.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1681,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1625)
         {
            _loc6_ = !this.var_286.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_286.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_95.getValue(AvatarType.const_71) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_95.getValue(AvatarType.const_71);
      ...
      {
         var _loc3_:AvatarStructure = this.var_95.getValue(AvatarType.const_117) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_117:
               _loc3_ = this.var_95.getValue(AvatarType.const_117) as AvatarStructure;
               break;
            case AvatarType.const_71:
               _loc3_ = this.var_95.getValue(AvatarType.const_71) as AvatarStructure;
               break;
            default:
