package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2414 = parseInt(param1.@precedence);
         this.var_2413 = String(param1.@activepartset);
         this.var_2409 = String(param1.@assetpartdefinition);
         this.var_2408 = String(param1.@lay);
         this.var_729 = String(param1.@geometrytype);
         this.var_2256 = Boolean(parseInt(param1.@main));
         this.var_2410 = Boolean(parseInt(param1.@HabboRoomWidgetLib_badge_details));
         this.var_2412 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "HabboRoomWidgetLib_badge_details")
            {
               this.var_2411 = _loc6_;
            }
            else
            {
               this.var_1713[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1713[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2411;
         }
         return _loc2_;
      }
