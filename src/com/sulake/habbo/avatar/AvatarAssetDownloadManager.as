package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_1994:int = 100;
      
      private const const_1357:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_968 = new Timer(this.const_1994,1);
         this.var_968.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_428)
         {
            this.var_428.addEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_428.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_428)
         {
            this.var_428.removeEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_428.removeEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               _loc2_ = this.var_1470 + "&retry=" + this.var_969;
            }
            else
            {
               _loc2_ = this.var_1470 + "?retry=" + this.var_969;
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1926 = true;
         for each(_loc2_ in this.var_1205)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2718,this._assets);
            _loc3_.addEventListener(Event.COMPLETE,this.libraryComplete);
            for each(_loc4_ in _loc2_.part)
            {
               _loc5_ = _loc4_.@type + ":" + _loc4_.@id;
               _loc6_ = this.var_1204[_loc5_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1926)
         {
            this.var_1205.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_506[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_506[_loc3_] = _loc6_;
            }
            this.var_967[_loc3_] = _loc4_;
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_967)
         {
            _loc7_ = true;
            _loc4_ = this.var_967[_loc3_];
            ...
            if(_loc7_)
            {
               ...
               delete this.var_506[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_967[_loc3_];
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_781.length > 0 && this.var_780.length < this.const_1357)
         {
