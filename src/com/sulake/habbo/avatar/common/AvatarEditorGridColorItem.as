package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_931:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_658.width,this.var_658.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_658,this.var_658.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1171.width,this.var_1171.height,true,0);
            _loc5_ = this.var_1171.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_931.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_930.width,this.var_930.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_930,this.var_930.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_931)
            {
               switch(this.var_931.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_62:
                     _loc4_.style = HabboIconType.const_735;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_54:
                     _loc4_.style = HabboIconType.const_858;
                     _loc4_.visible = true;
               }
            }
            else
