package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1209:IWindowContainer;
      ...
      private var var_488:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_487:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1115 = [];
         this.var_1367 = [AvatarEditorFigureCategory.const_862,AvatarEditorFigureCategory.const_46,AvatarEditorFigureCategory.const_211,AvatarEditorFigureCategory.const_719,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1209 == null)
         {
            ...
            var_1209 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1473 == null)
         {
         ...
         this.var_409 = new Timer(1000);
         this.var_409.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1367;
         }
         for each(_loc6_ in param4)
         {
            this.var_1115.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_409.stop();
            this.var_409.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_409 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1367);
         }
         if(param1.length != this.var_1115.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1115.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2456 = this.canChangeOutfit();
            this.var_409.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_488 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_488.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_488.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1115.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_488.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_488.numSelectables)
               {
                  this.var_488.getSelectableAt(_loc6_).x = this.var_488.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1367;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1747 == AvatarEditorSideCategory.const_105 || this.var_2455))
         {
      ...
      {
         if(this.var_1747 == AvatarEditorSideCategory.const_105)
         {
            this.var_2455 = false;
            this.setSideContent(AvatarEditorSideCategory.const_808);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_808:
               break;
            case AvatarEditorSideCategory.const_526:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_526);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_487)
         {
            ...
            this.var_487 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_487.procedure = this.stripClubDialogEventProc;
            this.var_487.center();
         }
         else
         {
