package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_505:IKeyExchange;
      
      private var var_925:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2599:PseudoRandom;
      ...
      private var var_215:HabboHotelView;
      
      private var var_1419:String = "";
      
      private const const_1695:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_611 = param1;
            this.var_49.initConnection(HabboConnectionType.const_260);
         }
      }
      ...
      {
         if(this.var_49 && this.var_129 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_215 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_129.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_129.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_215.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_129.getKey("use.sso.ticket") == "1";
         this.var_611 = this.var_129.getKey("sso.ticket",null);
         this.var_1828 = this.var_129.getKey("flash.client.url","");
         this.var_2598 = this.var_129.getKey("external.variables.txt","");
         if(this.var_215 == null)
         {
            this.var_215 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_49.mode = HabboConnectionType.const_116;
            if(this.var_611)
            {
               this.var_49.initConnection(HabboConnectionType.const_260);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_553,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_49.mode = HabboConnectionType.const_116;
            if(this.var_129.keyExists("local.environment"))
            {
               this.var_49.mode = HabboConnectionType.const_1012;
            }
         }
         this.var_49.initConnection(HabboConnectionType.const_260);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_757);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2599 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_49.mode)
         {
            case HabboConnectionType.const_116:
               _loc6_ = "";
               _loc6_ = this.var_129.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_129.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1419 = _loc4_;
               this.var_215.loadBannerImage(_loc7_ + "?token=" + this.var_1419,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1012:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1599:
               this.var_925 = this.generateRandomHexString(30);
               this.var_505 = new DiffieHellman(new BigInteger(this.var_129.getKey("connection.development.prime"),16),new BigInteger(this.var_129.getKey("connection.development.generator"),16));
               this.var_505.init(this.var_925);
               _loc8_ = this.var_505.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_505.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_505.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2599);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1828,this.var_2598));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1695,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_611 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_611);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2597)
         {
            _loc2_ = this.var_129.getKey("logout.disconnect.url");
            if(this.var_129.keyExists("facebook.user"))
            {
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2597 = true;
         var _loc2_:String = this.var_129.getKey("logout.url");
         if(_loc2_.length > 0)
         {
            _loc2_ = this.setReasonProperty(_loc2_,param1.reasonString);
            _loc2_ = this.setOriginProperty(_loc2_);
            _loc2_ += "&id=" + param1.method_1;
            HabboWebTools.openWebPage(_loc2_,"_self");
         }
      }
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_129.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1419);
         ...
         this.var_505 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_505.init(_loc14_);
            _loc15_ = this.var_505.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_925 = _loc14_;
            }
