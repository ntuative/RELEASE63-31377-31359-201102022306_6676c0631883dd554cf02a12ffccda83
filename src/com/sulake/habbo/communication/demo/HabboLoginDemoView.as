package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_553:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_159.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_140,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1695,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1695,"/");
         ...
         {
            dispatchEvent(new Event(const_553));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_130.removeEventListener(SSOTicket.const_379,this.onParsedTicketSuccess);
            this.var_130.removeEventListener(SSOTicket.const_313,this.onParsedTicketFailure);
            this.var_130 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_130 = new SSOTicket(this.var_159.assets,_loc3_,_loc2_,param1);
         this.var_130.addEventListener(SSOTicket.const_379,this.onParsedTicketSuccess);
         this.var_130.addEventListener(SSOTicket.const_313,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_130.ticket);
         Logger.log("Has Facebook: " + this.var_130.isFacebookUser);
         if(this.var_130.isFacebookUser)
         {
            this.var_159.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_159.shockwaveClientUrl = this.var_130.shockwaveClientUrl;
         this.var_159.ssoTicket = this.var_130.ticket;
         this.var_130.removeEventListener(SSOTicket.const_379,this.onParsedTicketSuccess);
         this.var_130.removeEventListener(SSOTicket.const_313,this.onParsedTicketFailure);
         this.var_130 = null;
         dispatchEvent(new Event(const_553));
