package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_410:uint = 3;
      
      private static const const_1241:uint = 1;
      ...
      private var var_833:IWindowRenderer;
      
      private var var_832:ISkinContainer;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_832 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_833 = new WindowRenderer(this.var_832);
         this.var_188 = new Array(const_410);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_410)
         {
            this.var_188[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_833,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_188[const_1241];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_375,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1509,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1588)
            {
               this.var_1588 = new ProfilerOutput(context,this,this.var_833);
            }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_188)
            {
               ...
               {
                  IDisposable(this.var_188.pop()).dispose();
               }
            }
            this.var_188 = null;
            if(this.var_324)
      ...
      {
         var _loc3_:Dictionary = this.var_324[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_324[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_832.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_188[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_188[param2].getDesktopWindow();
      ...
      {
         return this.var_188[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_188[param1].getDesktopWindow().getChildAt(this._windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_188[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_369.length > 0)
         {
            ...
            while(_loc2_ >= 0)
            {
               this.var_188[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1046)
         ...
         _loc2_ = 0;
         while(_loc2_ < const_410)
         {
            this.var_188[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1046)
         {
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1572,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1639,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1534,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_429,
            "style":WindowStyle.const_168,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
