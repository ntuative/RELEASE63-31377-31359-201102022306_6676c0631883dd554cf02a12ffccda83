package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1580:int = 0;
      ...
      private var var_2802:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_608 = [];
         this.var_533 = [];
         events.addEventListener(RoomContentLoadedEvent.const_399,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_474,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_884,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_609 == null || this.var_503 == null)
         {
            return;
         }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_503.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_503.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_48 == null || this.var_503 == null)
         {
            return;
         }
         ...
         var _loc5_:* = null;
         var _loc6_:int = this.var_114.length - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.var_114.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = this.var_114.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_503.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_503.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
