package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1491 || param2 != this.var_1492)
         {
      ...
      {
         if(this.var_1243 > 255 || bitmapData == null)
         {
            return false;
         }
