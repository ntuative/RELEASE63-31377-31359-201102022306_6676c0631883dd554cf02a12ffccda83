package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_257:BitmapDataCache;
      ...
      private var var_1433:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2631:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_256 = new Sprite();
         this.var_256.mouseEnabled = false;
         this.var_58 = new Sprite();
         this.var_58.name = "canvas";
         this.var_58.mouseEnabled = false;
         this.var_256.addChild(this.var_58);
         ...
         this.var_257 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
      ...
      {
         this.var_510.x -= param1 - this.var_619;
         this.var_619 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_510.y -= param1 - this.var_616;
         this.var_616 = param1;
      }
      ...
      {
         if(param1 && !this.var_927)
         {
            this.var_927 = true;
            if(this.var_132 != null && !this.var_256.contains(this.var_132))
            {
               this.var_256.addChild(this.var_132);
               this.var_58.mask = this.var_132;
            }
         }
         else if(!param1 && this.var_927)
         {
            this.var_927 = false;
            if(this.var_132 != null && this.var_256.contains(this.var_132))
            {
               this.var_256.removeChild(this.var_132);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_256.numChildren > 0)
            {
               this.var_256.removeChildAt(0);
            }
            this.var_256 = null;
         }
         this.var_58 = null;
         ...
         if(this.var_618 != null)
         {
            ...
            {
               this.cleanSprite(this.var_618[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_618 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_761 != this.var_2632 || this._ht != this.var_2633)
         {
            _loc9_ = true;
         }
         if(this.var_58.x != this.var_619 || this.var_58.y != this.var_616)
         {
            this.var_58.x = this.var_619;
            this.var_58.y = this.var_616;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_511[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2632 = this.var_761;
         this.var_2633 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_619;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_616;
                  if(_loc19_ < this.var_761 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_619;
                     _loc17_.y = _loc20_ - this.var_616;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_618.length > 0)
         {
            _loc3_ = this.var_618.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_762 || this.var_762 == 0)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_257.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_257.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_257.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_257.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_619;
         param2 -= this.var_616;
         this.var_510.x = param1;
         this.var_510.y = param2;
         if(this.var_1172 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1852;
         }
         this.var_1852 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1172;
         return this.var_1852;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_761 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1853,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_617.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_617.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2634 || param2 != this.var_2631)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_617.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_617.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_360.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1433.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1172 == 0)
         {
            this.checkMouseHits(this.var_510.x,this.var_510.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1172 = 0;
         ++this.var_1853;
      }
