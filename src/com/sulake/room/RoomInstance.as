   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_139 != null)
            {
               this.var_139.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_139)
               {
                  this.var_139.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_139)
                  {
                     this.var_139.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_139.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
