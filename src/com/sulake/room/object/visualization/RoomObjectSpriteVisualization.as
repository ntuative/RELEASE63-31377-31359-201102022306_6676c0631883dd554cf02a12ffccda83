package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_352:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_191 != null)
         {
            ...
            {
               _loc1_ = this.var_191[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_191.length > param1)
         {
            _loc2_ = this.var_191[this.var_191.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_191.length)
         {
